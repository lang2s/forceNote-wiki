...
사용자의 예정·현재·과거 활동을 시간순으로 표시하는 타임라인.
...
`.slds-timeline`  (관련 클래스 약 23개)  — 세부 정의는 SLDS 1 문서 참고
...
- 📐 SLDS 1 블루프린트(마크업/가이드): https://v1.lightningdesignsystem.com/components/activity-timeline/
