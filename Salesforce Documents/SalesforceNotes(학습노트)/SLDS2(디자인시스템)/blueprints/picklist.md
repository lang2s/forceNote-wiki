...
HTML select와 유사한 select-only 컴포넌트(단일/다중 선택 listbox).
...
`.slds-listbox`  (관련 클래스 약 26개)  — 세부 정의는 SLDS 1 문서 참고

`.slds-combobox`  (관련 클래스 약 13개)
...
- 📐 SLDS 1 블루프린트(마크업/가이드): https://v1.lightningdesignsystem.com/components/picklist/
