...
'장바구니' 방식으로 부모 객체에 여러 항목을 빠르게 추가. (listbox/dueling-list 패턴)
...
- 📐 SLDS 1 블루프린트(마크업/가이드): https://v1.lightningdesignsystem.com/components/list-builder/
