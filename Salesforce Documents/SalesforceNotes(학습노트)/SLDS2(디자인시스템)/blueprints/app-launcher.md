...
`.slds-app-launcher`  (관련 클래스 약 11개)  — 세부 정의는 SLDS 1 문서 참고
...
- 📐 SLDS 1 블루프린트(마크업/가이드): https://v1.lightningdesignsystem.com/components/app-launcher/
