...
```sfdocs-code {"lang":"agentscript", "title": "Required Verification Flow"}
...
```sfdocs-code {"lang":"agentscript", "title": "Required Flow in a Subagent"}
...
See [Agent Script Example: Use Step Variables to Enforce Subagent Workflows](../../agent-examples/ascript-examples-multi-turn.md).
