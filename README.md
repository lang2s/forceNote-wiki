...
│   ├── _index/                  키워드 검색 샤드 (32개)
│   ├── Apex/ LWC/ DevOps/ Admin/ Agentforce/ AgentSkills/ FieldService/ Analytics/ CPQ/ Scheduler/ Service/ SalesCloud/ DataCloud/ Clouds/ Visualforce/ Security/ …  섹션별 패턴 + 레퍼런스 노트 (현황·수치는 forceNote-wiki/README.md 참조)
