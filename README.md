...
│   ├── _index/                  키워드 검색 샤드 (25개)
│   ├── Apex/ LWC/ DevOps/ Agentforce/ AgentSkills/ FieldService/ Analytics/ CPQ/ Scheduler/ Service/ Visualforce/ …  섹션별 패턴 + 레퍼런스 노트 (현황·수치는 forceNote-wiki/README.md 참조)
