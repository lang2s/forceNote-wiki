---
tags: [agent-skill, sf-skills, reference, commerce, b2b, webstore, storefront, metadata]
source: forcedotcom/sf-skills (skills/commerce-b2b-store-create/references/store-vs-storefront.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Commerce Store vs Storefront, 커머스 스토어 vs 스토어프론트, WebStore, ExperienceBundle, Commerce B2B]
---
# Commerce Store vs Storefront: Technical Reference — 커머스 스토어 vs 스토어프론트 기술 참조

> Commerce B2B에서 Store(백엔드 데이터)와 Storefront(프런트엔드 메타데이터)의 차이와, 반드시 Store를 먼저 만들어야 하는 생성 순서를 설명하는 기술 문서.
