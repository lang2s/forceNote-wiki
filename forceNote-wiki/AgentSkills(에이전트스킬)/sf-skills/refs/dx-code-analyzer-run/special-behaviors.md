---
tags: [agent-skill, sf-skills, reference, dx, code-analyzer, special-behaviors]
source: forcedotcom/sf-skills (skills/dx-code-analyzer-run/references/special-behaviors.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Special Behaviors, 특수 동작, SFGE 워크스페이스, ApexGuru, AppExchange 보안 리뷰, diff scan]
---
# Special Behaviors — 엔진별 특수 동작 및 고급 시나리오

> SFGE 워크스페이스 컴파일 동작, ApexGuru 인증, AppExchange 보안 리뷰, diff 기반 스캔, 대규모 결과 처리 등 고급 스캐닝 시나리오와 엔진별 주의사항.
