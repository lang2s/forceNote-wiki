---
tags: [agent-skill, sf-skills, reference, platform, metadata-api]
source: forcedotcom/sf-skills (skills/platform-metadata-api-context-get/references/usage_guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Metadata API Usage Guide, 메타데이터 API 사용 가이드, token optimization, section-specific loading]
---
# Metadata API Skill — Usage Guide (메타데이터 API 스킬 사용 가이드)

> `platform-metadata-api-context-get` 스킬의 심화 배경: 토큰 최적화, 섹션 단위 로딩, 메타데이터 파일 생성 레퍼런스, 공통 워크플로우.
