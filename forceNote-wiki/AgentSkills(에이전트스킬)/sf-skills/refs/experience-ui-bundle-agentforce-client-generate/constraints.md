---
tags: [agent-skill, sf-skills, reference, experience, ui-bundle, agentforce, constraints, anti-patterns]
source: forcedotcom/sf-skills (skills/experience-ui-bundle-agentforce-client-generate/references/constraints.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Constraints and Anti-Patterns, 제약 조건, 안티패턴, AgentforceConversationClient 금지사항]
---

# Constraints and Anti-Patterns — 제약 조건과 안티패턴

> AgentforceConversationClient 작업 시 피해야 할 모든 잘못된 접근과 패턴 목록.
