---
tags: [agent-skill, sf-skills, reference, experience, ui-bundle, agentforce, style-tokens, theming]
source: forcedotcom/sf-skills (skills/experience-ui-bundle-agentforce-client-generate/references/style-tokens.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Style Tokens Reference, 스타일 토큰, 테마, styleTokens, AgentforceConversationClient 테마]
---

# Style Tokens Reference — 스타일 토큰 레퍼런스

> AgentforceConversationClient의 외형을 커스터마이즈하는 유일한 방법인 `styleTokens` prop의 전체 토큰 목록과 사용법.
...
- [[experience-ui-bundle-agentforce-client-generate/examples|examples]]
- [[constraints]]
