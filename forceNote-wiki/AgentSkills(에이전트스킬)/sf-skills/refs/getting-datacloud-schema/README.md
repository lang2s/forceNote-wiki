---
tags: [agent-skill, sf-skills, reference, data-cloud, schema, dlo, dmo, rest-api]
source: forcedotcom/sf-skills (skills/getting-datacloud-schema/references/README.md, 공식 Salesforce)
created: 2026-06-27
aliases: [getting-datacloud-schema, 데이터클라우드 스키마 조회, DLO DMO schema, ssot REST API]
---
# getting-datacloud-schema Skill — 데이터 클라우드 스키마 조회

> REST API(`/services/data/v64.0/ssot/...`)로 Salesforce Data Cloud의 DLO(Data Lake Object)·DMO(Data Model Object) 스키마 정보를 조회하는 스킬.
