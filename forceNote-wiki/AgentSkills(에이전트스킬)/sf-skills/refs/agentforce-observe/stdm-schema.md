---
tags: [agent-skill, sf-skills, reference, agentforce, stdm-schema]
source: forcedotcom/sf-skills (skills/agentforce-observe/references/stdm-schema.md, 공식 Salesforce)
created: 2026-06-27
aliases: [STDM Schema, 세션 트레이스 데이터 모델, DMO 스키마, AiAgentSession, TRUST_GUARDRAILS_STEP]
---

# STDM Schema Reference — STDM 스키마 레퍼런스

> Session Trace Data Model(STDM)의 DMO 데이터 계층, 핵심 필드 매핑, TRUST_GUARDRAILS_STEP, 데이터 품질 노트, Data Space 이름, 에이전트 이름 해석 규칙을 다루는 레퍼런스.
