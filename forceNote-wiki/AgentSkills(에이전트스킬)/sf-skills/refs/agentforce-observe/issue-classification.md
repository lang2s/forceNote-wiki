---
tags: [agent-skill, sf-skills, reference, agentforce, issue-classification]
source: forcedotcom/sf-skills (skills/agentforce-observe/references/issue-classification.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Issue Classification, 이슈 분류, 근본 원인 카테고리, 구조 분석 체크, 지식 갭 분석]
---

# Issue Classification Reference — 이슈 분류 레퍼런스

> Agentforce 관측성에서 세션을 패턴별로 점검해 근본 원인 카테고리로 분류하고, `.agent` 파일 대상 구조 분석 체크(데드 허브·고아 액션·변수 의존성)와 지식 갭 분석을 수행하는 레퍼런스.
