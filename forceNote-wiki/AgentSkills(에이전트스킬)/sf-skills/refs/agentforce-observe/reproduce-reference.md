---
tags: [agent-skill, sf-skills, reference, agentforce, reproduce]
source: forcedotcom/sf-skills (skills/agentforce-observe/references/reproduce-reference.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Reproduce Phase, 재현 단계, 라이브 프리뷰, 시나리오 분류, CONFIRMED]
---

# Phase 2: Reproduce — 라이브 프리뷰 풀 레퍼런스

> Phase 1 발견 사항으로 테스트 시나리오를 구성하고 `sf agent preview`로 격리 세션에서 재현, 로컬 트레이스 진단, 각 시나리오를 3회 실행해 CONFIRMED/INTERMITTENT/NOT REPRODUCED로 분류하는 레퍼런스.
