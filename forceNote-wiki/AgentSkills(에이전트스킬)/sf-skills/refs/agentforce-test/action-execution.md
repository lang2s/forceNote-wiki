---
tags: [agent-skill, sf-skills, reference, agentforce, action-execution]
source: forcedotcom/sf-skills (skills/agentforce-test/references/action-execution.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Action Execution, 액션 실행, 에이전트포스 액션 테스트, Flow Apex action REST]
---

# Action Execution — 액션 실행 풀 레퍼런스

> Agentforce 액션(Flow·Apex)을 Salesforce 조직에 직접 실행해 테스트·디버깅하기 위한 안전 게이트, REST 호출, 통합 테스트, 에러 처리 전체 레퍼런스.
...
- [[agentforce-test]]
- [[preview-testing]]
- [[agentforce-test/troubleshooting|troubleshooting]]
