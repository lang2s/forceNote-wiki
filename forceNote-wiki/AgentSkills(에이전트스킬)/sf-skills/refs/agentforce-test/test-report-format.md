---
tags: [agent-skill, sf-skills, reference, agentforce, test-report]
source: forcedotcom/sf-skills (skills/agentforce-test/references/test-report-format.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Test Report Format, 테스트 리포트 포맷, 커버리지 분석, CI/CD agent testing, cross-skill observe]
---

# Test Report Format, Coverage Analysis, and CI/CD — 테스트 리포트·커버리지·CI/CD 레퍼런스

> Agentforce 테스트 결과 요약/상세 리포트 포맷, 커버리지 분석 차원, Testing Center 기반 CI/CD 워크플로, /agentforce-observe 크로스 스킬 통합(회귀 테스트 케이스)을 다루는 레퍼런스.
