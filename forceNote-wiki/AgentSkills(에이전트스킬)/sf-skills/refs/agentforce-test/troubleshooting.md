---
tags: [agent-skill, sf-skills, reference, agentforce, troubleshooting]
source: forcedotcom/sf-skills (skills/agentforce-test/references/troubleshooting.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Agent Test Troubleshooting, 에이전트 테스트 문제 해결, 방어적 JSON 파싱, 디버그 모드, exit codes]
---

# Troubleshooting, Best Practices, and Dependencies — 문제 해결·베스트 프랙티스·의존성 레퍼런스

> Agentforce 테스트의 일반 이슈/원인/해결, 제어문자에 대한 방어적 JSON 파싱(Python re.sub), 디버그 모드, 테스트 전략, 의존성, exit code를 다루는 레퍼런스.
