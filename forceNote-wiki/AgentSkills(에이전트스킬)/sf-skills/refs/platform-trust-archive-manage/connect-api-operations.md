---
tags: [agent-skill, sf-skills, reference, platform, archive]
source: forcedotcom/sf-skills (skills/platform-trust-archive-manage/references/connect-api-operations.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Salesforce Archive Connect API, 아카이브 Connect API 오퍼레이션, search-archived-records, RTBF, mask-archived-records]
---
# Salesforce Archive Connect API — Operations Reference (아카이브 Connect API 오퍼레이션)

> `/platform/data-resilience/archive/` 하위 Connect API 전 오퍼레이션의 메서드·경로·입출력·검증 의존성·비명시적 계약을 정리한 레퍼런스.
