...
source: forcedotcom/sf-skills (skills/platform-trust-archive-manage/references/archive-activity-entity.md, 공식 Salesforce)
created: 2026-06-27
aliases: [ArchiveActivity, 아카이브 작업 엔티티, Salesforce Archive job metadata, 8qv]
---
# ArchiveActivity — Data Model Reference (아카이브 작업 데이터 모델)

> Salesforce Archive 작업(archive·purge·analyze·unarchive·export)의 메타데이터를 기록하는 플랫폼 엔티티 `ArchiveActivity`의 필드·상태·로그 다운로드 연동 레퍼런스.
