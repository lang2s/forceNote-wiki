---
tags: [agent-skill, sf-skills, reference, mobile, offline, lwc, eslint, komaci, static-analysis]
source: forcedotcom/sf-skills (skills/mobile-platform-offline-validate/references/komaci-eslint.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Komaci ESLint Static Analysis, lwc-graph-analyzer, ESLint 오프라인 규칙, Komaci priming 규칙]
---

# Komaci ESLint Static Analysis (`@salesforce/eslint-plugin-lwc-graph-analyzer`) — Komaci ESLint 정적 분석

> Komaci 오프라인 분석기를 ESLint 플러그인으로 실행하여 priming을 막는 LWC 패턴을 잡아내는 방법과, 보고 대상 7개 규칙별 표준 remediation.
