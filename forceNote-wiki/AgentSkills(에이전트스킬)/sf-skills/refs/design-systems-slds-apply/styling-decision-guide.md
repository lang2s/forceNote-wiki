---
tags: [agent-skill, sf-skills, reference, slds, design-system, styling-hooks]
source: forcedotcom/sf-skills (skills/design-systems-slds-apply/references/styling-decision-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Styling Decision Guide, 스타일링 결정 가이드, 스타일 훅 계층, 85-5-10 rule, hook vs utility vs custom]
---

# Styling Decision Guide — SLDS 스타일링 결정 가이드

> 훅·유틸리티·커스텀 CSS를 올바르게 적용하는 방법. `--slds-g-*` 글로벌 훅 기본 사용, 85-5-10 색상 규칙, 4-point 그리드 spacing, 타이포그래피 네이밍 예외, 훅이 없을 때의 의사결정 트리.
