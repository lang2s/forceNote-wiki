---
tags: [agent-skill, sf-skills, reference, slds, design-system, component-selection]
source: forcedotcom/sf-skills (skills/design-systems-slds-apply/references/component-selection.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Component Blueprint Selection, 컴포넌트 블루프린트 선택, LBC blueprint, SLDS 아티팩트 선택]
---

# Component & Blueprint Selection — 컴포넌트·블루프린트 선택

> UI 패턴에 맞는 SLDS 아티팩트를 찾는 방법. LWC면 Lightning Base Component(LBC) 먼저, 없으면 SLDS Blueprint, 그것도 없으면 스타일 훅으로 커스텀.
