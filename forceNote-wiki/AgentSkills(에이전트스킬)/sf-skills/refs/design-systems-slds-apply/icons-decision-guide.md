---
tags: [agent-skill, sf-skills, reference, slds, design-system, icons]
source: forcedotcom/sf-skills (skills/design-systems-slds-apply/references/icons-decision-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Icons Decision Guide, 아이콘 결정 가이드, SLDS 아이콘, utility standard action icon, lightning-icon]
---

# Icons Decision Guide — SLDS 아이콘 선택 가이드

> SLDS 아이콘 5개 카테고리(utility·standard·action·custom·doctype) 중 올바른 것을 고르고, LWC/비-LWC에서 올바르게 사용하며 접근성 규칙을 지키는 가이드.
