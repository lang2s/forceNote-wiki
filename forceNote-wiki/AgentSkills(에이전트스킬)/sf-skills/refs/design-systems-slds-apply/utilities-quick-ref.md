---
tags: [agent-skill, sf-skills, reference, slds, design-system, utilities]
source: forcedotcom/sf-skills (skills/design-systems-slds-apply/references/utilities-quick-ref.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Utilities Quick Reference, 유틸리티 클래스 빠른 참조, SLDS utility classes, grid margin padding sizing]
---

# Utilities Quick Reference — SLDS 유틸리티 클래스 빠른 참조

> 빠른 스타일링을 위한 SLDS 유틸리티 클래스. 27개 카테고리 1,147개 클래스 중 grid·margin·padding·sizing·typography·visibility·truncation 등 가장 자주 쓰는 것 정리. 유틸리티 vs 훅 선택 기준 포함.
