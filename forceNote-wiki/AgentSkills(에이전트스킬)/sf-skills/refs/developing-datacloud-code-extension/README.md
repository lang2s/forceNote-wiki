---
tags: [agent-skill, sf-skills, reference, data-cloud, code-extension, python]
source: forcedotcom/sf-skills (skills/developing-datacloud-code-extension/references/README.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Data Cloud Code Extension, 데이터클라우드 코드 익스텐션, data-code-extension, Python transform]
---
# developing-datacloud-code-extension Skill — 데이터 클라우드 코드 익스텐션 개발

> SF CLI 플러그인으로 Salesforce Data Cloud에 커스텀 Python 코드 익스텐션을 개발·테스트·배포하는 전체 워크플로(init → develop → scan → run → deploy).
