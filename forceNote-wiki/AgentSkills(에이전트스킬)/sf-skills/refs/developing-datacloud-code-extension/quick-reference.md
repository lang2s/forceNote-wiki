---
tags: [agent-skill, sf-skills, reference, data-cloud, code-extension, python, cheatsheet]
source: forcedotcom/sf-skills (skills/developing-datacloud-code-extension/references/quick-reference.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Data Cloud Code Extension Quick Reference, 코드 익스텐션 치트시트, data-code-extension cheatsheet, config.json]
---
# Data Cloud Code Extension - Quick Reference — 코드 익스텐션 빠른 참조

> data-code-extension 명령어(init/scan/run/deploy), Python 코드 패턴, 옵션·쓰기 모드·config.json 포맷·배포 체크리스트 치트시트.
...
- [[developing-datacloud-code-extension/README|README]]
