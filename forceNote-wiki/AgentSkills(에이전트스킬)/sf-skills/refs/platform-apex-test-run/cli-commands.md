---
tags: [agent-skill, sf-skills, reference, platform, apex-test, cli]
source: forcedotcom/sf-skills (skills/platform-apex-test-run/references/cli-commands.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Salesforce CLI Test Commands, sf apex run test, Apex 테스트 CLI 명령어, 테스트 실행 명령어]
---
# Salesforce CLI Test Commands Reference — Apex 테스트 CLI 명령어 레퍼런스

> `sf apex run test` 계열 명령어로 Apex 테스트를 실행·커버리지 수집·비동기 실행·CI/CD 연동하는 전체 명령어 레퍼런스.
