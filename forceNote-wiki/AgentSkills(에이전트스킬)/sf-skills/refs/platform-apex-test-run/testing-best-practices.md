---
tags: [agent-skill, sf-skills, reference, platform, apex-test, best-practices]
source: forcedotcom/sf-skills (skills/platform-apex-test-run/references/testing-best-practices.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Apex Testing Best Practices, AAA pattern, 테스트 베스트 프랙티스, 테스트 피라미드, negative testing, governor limit testing]
---
# Apex Testing Best Practices — Apex 테스트 베스트 프랙티스

> 테스트 피라미드·AAA 패턴·Test Data Factory·@TestSetup·벌크/네거티브 테스트·모킹·거버너 한도 테스트·안티패턴·테스트 속도 철학을 망라한 종합 가이드.
