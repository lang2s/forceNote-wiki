---
tags: [agent-skill, sf-skills, reference, platform, apex-test, performance]
source: forcedotcom/sf-skills (skills/platform-apex-test-run/references/performance-optimization.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Apex Test Performance, 테스트 성능 최적화, DML mocking speed, 빠른 테스트, 테스트 속도]
---
# Performance Optimization for Apex Tests — Apex 테스트 성능 최적화

> DML/SOQL 모킹, @TestSetup 최소화, 효율적 루프, 벌크 데이터 생성 등으로 테스트 실행 시간을 초 단위로 줄이는 9가지 기법과 안티패턴.
...
- [[platform-apex-test-run/mocking-patterns|mocking-patterns]]
