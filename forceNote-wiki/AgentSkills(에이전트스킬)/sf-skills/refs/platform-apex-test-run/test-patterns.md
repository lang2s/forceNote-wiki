---
tags: [agent-skill, sf-skills, reference, platform, apex-test, templates]
source: forcedotcom/sf-skills (skills/platform-apex-test-run/references/test-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Apex Test Patterns, Test Templates, 테스트 패턴, 테스트 템플릿, bulk test, mock callout test]
---
# Test Patterns & Templates — Apex 테스트 패턴과 템플릿

> 기본 테스트 클래스·벌크(251건) 테스트·Mock callout 테스트·Test Data Factory 4가지 재사용 가능한 Apex 테스트 템플릿.
