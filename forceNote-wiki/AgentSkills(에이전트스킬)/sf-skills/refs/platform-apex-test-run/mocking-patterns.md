---
tags: [agent-skill, sf-skills, reference, platform, apex-test, mocking]
source: forcedotcom/sf-skills (skills/platform-apex-test-run/references/mocking-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Mocking Patterns Apex, HttpCalloutMock, DML Mocking, StubProvider, Apex 모킹 패턴, 스텁]
---
# Mocking Patterns in Apex Tests — Apex 테스트 모킹 패턴

> HttpCalloutMock·DML 모킹·StubProvider·Selector 모킹으로 DB·외부 서비스를 대체해 빠르고 고립된 단위 테스트를 작성하는 패턴 모음.
