---
tags: [agent-skill, sf-skills, reference, lwc, experience, cli]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/cli-commands.md, 공식 Salesforce)
created: 2026-06-27
aliases: [LWC CLI Commands, CLI 명령어, sf template generate, lwc 개발 명령어]
---

# Salesforce CLI Commands for LWC Development — LWC 개발용 Salesforce CLI 명령어

> LWC 개발에 쓰이는 Salesforce CLI 명령어 빠른 참조 — 컴포넌트 생성·배포·테스트 등.
