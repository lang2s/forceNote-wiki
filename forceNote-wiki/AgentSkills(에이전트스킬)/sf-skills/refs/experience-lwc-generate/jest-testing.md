---
tags: [agent-skill, sf-skills, reference, lwc, experience, testing]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/jest-testing.md, 공식 Salesforce)
created: 2026-06-27
aliases: [LWC Jest Testing, Jest 테스트, 테스트 패턴, sfdx-lwc-jest]
---

# Advanced Jest Testing for LWC — LWC Jest 고급 테스트

> Jest를 사용한 Lightning Web Component 고급 테스트 종합 가이드 (James Simone의 고급 테스트 패턴 기반).
