---
tags: [agent-skill, sf-skills, reference, lwc, experience, slds]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/slds-design-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [SLDS Design, SLDS 디자인, blueprints, Lightning Base Component]
---

# SLDS Design — SLDS 디자인 가이드

> SLDS 블루프린트를 사용해 커스텀 HTML/CSS를 디자인하는 가이드 — 언제 blueprint를 쓸지 판단 기준 포함.
...
```html
<!-- 구조 예시 — 실제 동작 코드 아님: 아래 표의 매핑(개념 → 권장 base component) 사용 예시 -->
<!-- Salesforce 내부에서는 base component 우선 -->
<lightning-button label="Save" variant="brand"></lightning-button>

<!-- base component가 없거나 비-Salesforce 플랫폼이면 SLDS blueprint(커스텀 HTML/CSS) -->
