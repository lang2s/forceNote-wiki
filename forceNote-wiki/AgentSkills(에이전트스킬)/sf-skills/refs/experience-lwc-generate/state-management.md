---
tags: [agent-skill, sf-skills, reference, lwc, experience, state-management]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/state-management.md, 공식 Salesforce)
created: 2026-06-27
aliases: [LWC State Management, 상태 관리, @lwc/state, Platform State Managers]
---

# LWC State Management — LWC 상태 관리

> @lwc/state와 Platform State Manager를 사용하는 현대적 LWC 상태 관리 패턴.
