...
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/scoring-and-testing.md, 공식 Salesforce)
created: 2026-06-27
aliases: [SLDS 2 Scoring, 165-Point Scoring, SLDS 2 검증, Jest 테스트 채점]
---

# SLDS 2 Validation (165-Point Scoring) & Jest Testing — SLDS 2 검증 및 Jest 테스트

> SLDS 2 검증을 위한 165점 채점 기준과 Jest 테스트 항목 정리.
