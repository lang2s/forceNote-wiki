---
tags: [agent-skill, sf-skills, reference, lwc, experience, lms]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/lms-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Lightning Message Service, LMS, 메시지 서비스, cross-DOM 통신, MessageChannel]
---

# Lightning Message Service (LMS) Guide — LMS 가이드

> Lightning Message Service를 통한 DOM 간(cross-DOM) 컴포넌트 통신 완전 가이드.
