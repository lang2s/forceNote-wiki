---
tags: [agent-skill, sf-skills, reference, lwc, experience, patterns]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/component-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [LWC Component Patterns, 컴포넌트 패턴, 코드 예제]
---

# LWC Component Patterns — LWC 컴포넌트 패턴

> 자주 쓰이는 Lightning Web Component 패턴의 종합 코드 예제 모음.
