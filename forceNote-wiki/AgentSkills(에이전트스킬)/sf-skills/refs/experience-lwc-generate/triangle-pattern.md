---
tags: [agent-skill, sf-skills, reference, lwc, experience, architecture]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/triangle-pattern.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Triangle Pattern, Flow LWC Apex Triangle, 트라이앵글 패턴, 아키텍처 패턴]
---

# Flow-LWC-Apex Triangle - LWC Perspective — Flow-LWC-Apex 트라이앵글 (LWC 관점)

> Flow·LWC·Apex가 함께 동작하는 Triangle 아키텍처를 LWC의 역할 관점에서 설명하는 가이드.
...
| Topic | Location |
|-------|----------|
| Flow screen component template | `experience-lwc-generate/assets/flow-screen-component/` |
| LWC best practices | `experience-lwc-generate/references/lwc-best-practices.md` |
