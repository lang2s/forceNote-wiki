---
tags: [agent-skill, sf-skills, reference, lwc, experience, performance]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/performance-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [LWC Performance, 성능 최적화, lazy loading, rendering optimization, dark mode]
---

# Performance Optimization Guide for LWC — LWC 성능 최적화 가이드

> Lightning Web Component 성능 최적화 종합 가이드 — 다크 모드 구현·지연 로딩·렌더링 최적화.
