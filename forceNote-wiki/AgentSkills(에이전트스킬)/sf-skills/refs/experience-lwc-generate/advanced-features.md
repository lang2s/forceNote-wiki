...
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/advanced-features.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Flow Screen Integration, Flow 화면 통합, 고급 기능, FlowAttributeChangeEvent]
---

# Flow Screen Integration & Advanced Features — Flow 화면 통합 및 고급 기능

> LWC를 Flow Screen에 임베드하기 위한 통합과 그 밖의 고급 기능 패턴.
