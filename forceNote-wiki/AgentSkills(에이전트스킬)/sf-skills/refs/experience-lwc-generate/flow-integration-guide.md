---
tags: [agent-skill, sf-skills, reference, lwc, experience, flow]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/flow-integration-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [LWC Flow Integration, Flow 통합, Flow Screen, FlowNavigationNextEvent]
---

# LWC Flow Integration Guide — LWC Flow 통합 가이드

> Salesforce Flow Screen에서 사용할 Lightning Web Component를 만드는 통합 가이드.
