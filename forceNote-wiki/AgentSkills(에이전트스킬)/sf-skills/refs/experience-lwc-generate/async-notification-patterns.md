---
tags: [agent-skill, sf-skills, reference, lwc, experience, async]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/async-notification-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Async Notification Patterns, 비동기 알림, Platform Events, Change Data Capture, Emp API, 실시간 알림]
---

# Async Notification Patterns in LWC — LWC 비동기 알림 패턴

> Platform Events·Change Data Capture·Emp API를 활용한 LWC 실시간 알림 패턴 가이드.
