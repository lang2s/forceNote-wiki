---
tags: [agent-skill, sf-skills, reference, lwc, experience, accessibility]
source: forcedotcom/sf-skills (skills/experience-lwc-generate/references/accessibility-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [LWC Accessibility, 접근성, WCAG 2.1 AA, ARIA, 스크린 리더]
---

# Accessibility Guide for LWC — LWC 접근성 가이드

> WCAG 2.1 AA를 준수하는 Lightning Web Component를 만들기 위한 종합 가이드 — 시맨틱 HTML·ARIA·키보드 내비게이션·폼·색 대비·스크린 리더 대응.
