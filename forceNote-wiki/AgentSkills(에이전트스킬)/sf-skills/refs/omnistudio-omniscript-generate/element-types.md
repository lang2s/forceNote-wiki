---
tags: [agent-skill, sf-skills, reference, omnistudio, omniscript]
source: forcedotcom/sf-skills (skills/omnistudio-omniscript-generate/references/element-types.md, 공식 Salesforce)
created: 2026-06-27
aliases: [OmniScript element types, 옴니스크립트 엘리먼트 타입, PropertySetConfig, 입력 엘리먼트, 액션 엘리먼트]
---

# OmniScript Element Type Reference — OmniScript 엘리먼트 타입 레퍼런스

> OmniProcessElement의 모든 엘리먼트 타입(컨테이너/입력/표시/액션/로직)과 PropertySetConfig 속성·ElementType 매핑 전수 레퍼런스.
...
- [[omnistudio-omniscript-generate/best-practices|best-practices]]
