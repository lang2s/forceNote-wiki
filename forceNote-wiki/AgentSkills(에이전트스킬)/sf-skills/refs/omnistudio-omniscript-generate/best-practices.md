...
source: forcedotcom/sf-skills (skills/omnistudio-omniscript-generate/references/best-practices.md, 공식 Salesforce)
created: 2026-06-27
aliases: [OmniScript best practices, 옴니스크립트 모범사례, 스텝 설계, 검증, 내비게이션, 임베딩]
---

# OmniScript Best Practices — OmniScript 모범 사례

> OmniScript 스텝 설계 패턴, 데이터 프리필·검증·내비게이션·성능 최적화, 임베딩 vs 링크, 명명·오류 처리·테스트·보안.
...
- [[omnistudio-omniscript-generate/element-types|element-types]]
