---
tags: [agent-skill, sf-skills, reference, platform, metadata, orchestration]
source: forcedotcom/sf-skills (skills/platform-metadata-deploy/references/orchestration.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Multi-Skill Orchestration, 배포 순서, deploy order, 멀티 스킬 오케스트레이션, 의존성 순서, two-step deployment]
---
# Multi-Skill Orchestration: platform-metadata-deploy Perspective — 멀티 스킬 오케스트레이션 (배포 관점)

> platform-metadata-deploy가 Salesforce 개발 멀티 스킬 흐름에서 차지하는 위치, 표준/내부/Agentforce 배포 순서, 순서 오류 진단, 2단계 배포 패턴.
