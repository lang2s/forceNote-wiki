---
tags: [agent-skill, sf-skills, reference, platform, metadata, agentforce]
source: forcedotcom/sf-skills (skills/platform-metadata-deploy/references/agent-deployment-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Agentforce Agent Deployment, Agent pseudo metadata, GenAiPlannerBundle, BotVersion, 에이전트 배포, plannerSurfaces, BotTemplate]
---
# Agentforce Agent Deployment Guide — Agentforce 에이전트 배포 가이드

> SF CLI로 Agentforce 에이전트를 retrieve/deploy, 활성화/비활성화, 미리보기, 의존성 순서 배포, plannerSurfaces 패치, ISV BotTemplate 패키징까지 다루는 완전 배포 가이드.
...
- [Agentforce Testing Guide](../../agentforce-test/SKILL.md)

## 관련 노트
- [[platform-metadata-deploy]]
- [[platform-metadata-deploy/orchestration|orchestration]]
