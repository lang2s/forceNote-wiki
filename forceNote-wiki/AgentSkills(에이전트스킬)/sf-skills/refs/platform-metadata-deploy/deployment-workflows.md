---
tags: [agent-skill, sf-skills, reference, platform, metadata, workflows]
source: forcedotcom/sf-skills (skills/platform-metadata-deploy/references/deployment-workflows.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Deployment Workflow Examples, 배포 워크플로우, quick deploy, destructive changes, scratch org, rollback, 배포 예제]
---
# Salesforce Deployment Workflow Examples — Salesforce 배포 워크플로우 예제

> 프로덕션 배포·선택 배포·핫픽스·매니페스트·스크래치 오그·롤백·파괴적 변경·다중 환경·커버리지 분석·오류 복구 등 10가지 실전 배포 시나리오.
