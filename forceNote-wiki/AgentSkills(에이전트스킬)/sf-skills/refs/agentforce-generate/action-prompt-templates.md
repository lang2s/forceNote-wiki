...
source: forcedotcom/sf-skills (skills/agentforce-generate/references/action-prompt-templates.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Prompt Template Actions, 프롬프트 템플릿 액션, generatePromptResponse]
---

# Prompt Template Actions — 프롬프트 템플릿 액션

> Agent Script 안에서 `generatePromptResponse://` 프로토콜로 Salesforce Prompt Template을 액션으로 호출하는 방법 — 정의/호출 문법, grounded data 통합, 공통 패턴, 알려진 제약(run 키워드)과 오류 대응.
