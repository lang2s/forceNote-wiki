...
source: forcedotcom/sf-skills (skills/agentforce-generate/assets/README-legacy.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Agent Script Templates, 에이전트 스크립트 템플릿, assets 디렉토리 구조]
---

# Agent Script Templates — 에이전트 스크립트 템플릿 모음

> Agentforce 에이전트를 만들기 위한 `assets/` 폴더의 템플릿 인벤토리 — agents / components / patterns / metadata 4개 하위 폴더 구조와 각 템플릿 목록.
