---
tags: [agent-skill, sf-skills, reference, agentforce, production-gotchas]
source: forcedotcom/sf-skills (skills/agentforce-generate/references/production-gotchas.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Production Gotchas, 프로덕션 함정, billing determinism performance]
---

# Production Gotchas - Billing, Determinism & Performance — 프로덕션 함정

> Agentforce의 크레딧 소비, 라이프사이클 훅, 결정적(deterministic) 패턴, 성능 가드레일을 다룬다. 크레딧 표·생명주기 훅 문법·감독 vs 핸드오프·출력 플래그·토큰 한도 등을 포함.
