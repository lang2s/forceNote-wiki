---
tags: [agent-skill, sf-skills, reference, agentforce, deploy]
source: forcedotcom/sf-skills (skills/agentforce-generate/references/deploy-reference.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Deploy Bundle Publication, 번들 배포 게시, agent deployment lifecycle]
---

# Deploy - Bundle Publication Reference — 번들 배포·게시 레퍼런스

> Agentforce 에이전트의 전체 배포 라이프사이클(검증 → 메타데이터 배포 → 번들 게시 → 활성화)을 단계별로 다룬다. Deploy vs Publish 차이, 흔한 에러, 롤백, CI/CD 통합을 포함.
