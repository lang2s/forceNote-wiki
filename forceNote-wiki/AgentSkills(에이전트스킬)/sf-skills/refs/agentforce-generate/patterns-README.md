...
source: forcedotcom/sf-skills (skills/agentforce-generate/assets/patterns/README.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Agent Script Patterns, 에이전트 스크립트 고급 패턴, 패턴 결정 트리]
---

# Agent Script Patterns — 에이전트 스크립트 고급 패턴

> `assets/patterns/` 폴더의 재사용 가능한 고급 패턴 6종(action-callbacks, lifecycle-events, bidirectional-routing, advanced-input-bindings, system-instruction-overrides, open-gate-routing)과 패턴 결정 트리, 조합 방법, 검증 점수 영향, 안티패턴.
