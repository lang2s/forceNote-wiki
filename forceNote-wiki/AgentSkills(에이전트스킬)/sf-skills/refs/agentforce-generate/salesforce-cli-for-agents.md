---
tags: [agent-skill, sf-skills, reference, agentforce, salesforce-cli]
source: forcedotcom/sf-skills (skills/agentforce-generate/references/salesforce-cli-for-agents.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Salesforce CLI for Agents, 에이전트용 sf CLI, sf agent commands]
---

# Salesforce CLI for Agents Reference — 에이전트용 sf CLI 명령 레퍼런스

> 에이전트 생성·검증·미리보기·배포·게시·활성화/비활성화·테스트·Einstein Agent User 설정을 위한 `sf` CLI 명령을 명령별로 정리한 레퍼런스.
