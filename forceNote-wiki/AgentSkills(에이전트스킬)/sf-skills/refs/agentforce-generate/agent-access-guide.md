...
source: forcedotcom/sf-skills (skills/agentforce-generate/references/agent-access-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Agent Access Permissions, 에이전트 접근 권한, agentAccesses, Copilot 가시성 트러블슈팅]
---

# Agent Access Permissions & Visibility Troubleshooting — 에이전트 접근 권한 및 가시성 문제 해결

> 게시된 Employee Agent를 Lightning Experience Copilot 패널에서 최종 사용자에게 노출시키는 방법 — Permission Set의 `<agentAccesses>` 요소, 배포·할당, 가시성 문제 단계별 진단.
