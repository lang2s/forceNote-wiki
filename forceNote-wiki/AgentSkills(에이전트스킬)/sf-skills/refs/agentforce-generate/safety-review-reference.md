---
tags: [agent-skill, sf-skills, reference, agentforce, safety-review]
source: forcedotcom/sf-skills (skills/agentforce-generate/references/safety-review-reference.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Safety Review Reference, 안전성 검토 레퍼런스, responsible AI review]
---

# Safety Review Reference — `.agent` 안전성 검토 레퍼런스

> LLM 추론을 사용해 `.agent` 파일을 심층 보안·안전성 분석한다. 정규식이 잡지 못하는 의미적 위험을 7개 카테고리(BLOCK/WARN/INFO)로 검토하고, BLOCK이 하나라도 있으면 배포를 중단한다.
