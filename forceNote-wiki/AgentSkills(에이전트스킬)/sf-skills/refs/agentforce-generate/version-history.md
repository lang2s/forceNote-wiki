---
tags: [agent-skill, sf-skills, reference, agentforce, version-history]
source: forcedotcom/sf-skills (skills/agentforce-generate/references/version-history.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Version History, 버전 이력, agentforce-generate changelog]
---

# Version History — agentforce-generate 스킬 변경 이력

> agentforce-generate 스킬의 버전별 변경 이력(changelog).
...
스킬 버전은 SKILL.md frontmatter에서 확인한다.

```bash
# SKILL.md 상단 frontmatter의 version 필드 확인
grep -m1 '^version:' skills/agentforce-generate/SKILL.md
```
