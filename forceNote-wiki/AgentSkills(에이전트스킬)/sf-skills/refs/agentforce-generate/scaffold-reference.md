---
tags: [agent-skill, sf-skills, reference, agentforce, scaffold]
source: forcedotcom/sf-skills (skills/agentforce-generate/references/scaffold-reference.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Scaffold Stub Generation, 스텁 생성, flow apex stub generation]
---

# Scaffold - Stub Generation Reference — 스텁 생성 레퍼런스

> 조직에 존재하지 않는 Agent Script 타겟(Flow XML·Apex 클래스)에 대한 스텁 메타데이터를 생성한다. 연결 시 SObject 인지 필드 디스커버리를 수행하며, 그라운딩을 위한 현실적 스텁 데이터 작성이 핵심이다.
