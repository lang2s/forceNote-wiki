---
tags: [agent-skill, sf-skills, reference, agentforce, known-issues]
source: forcedotcom/sf-skills (skills/agentforce-generate/references/known-issues.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Known Issues Tracker, 알려진 이슈 추적, agent script platform bugs]
---

# Known Issues Tracker — Agent Script 알려진 플랫폼 이슈 추적

> 사용자 코드가 아닌 Salesforce 플랫폼에 원인이 있는 미해결 버그·제약·엣지 케이스를 추적한다. SKILL.md의 "Common Issues & Fixes"(해결된 트러블슈팅)와 달리, 이 파일은 열린 플랫폼 이슈를 다룬다.
