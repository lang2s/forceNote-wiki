...
source: forcedotcom/sf-skills (skills/agentforce-generate/assets/agent-spec-template.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Agent Spec Template, 에이전트 스펙 템플릿, 에이전트 설계 문서 양식]
---

# Agent Spec Template — 에이전트 스펙(설계 문서) 시작 템플릿

> 새 에이전트를 작성하기 전 produce하는 Agent Spec의 빈 양식 — Purpose & Scope, Behavioral Intent, Subagent Map, Variables, Actions & Backing Logic, Gating Logic, Architecture Pattern, Agent Configuration 섹션 골격.
