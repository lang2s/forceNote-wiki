---
tags: [agent-skill, sf-skills, reference, platform, data, crud]
source: forcedotcom/sf-skills (skills/platform-data-manage/references/crud-workflow-example.md, 공식 Salesforce)
created: 2026-06-27
aliases: [CRUD Workflow Example, CRUD 워크플로우 예제, Deal Desk 테스트, 데이터 생성-조회-수정-삭제]
---

# CRUD Workflow Example — CRUD 워크플로우 예제

> platform-data-manage 스킬로 발견→생성→수정→관계 생성→관계 조회→삭제까지 6단계 end-to-end 데이터 작업 예제.

Complete end-to-end example of data operations using platform-data-manage skill.
