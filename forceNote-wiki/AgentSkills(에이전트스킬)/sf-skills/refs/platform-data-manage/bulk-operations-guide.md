---
tags: [agent-skill, sf-skills, reference, platform, data, bulk-api]
source: forcedotcom/sf-skills (skills/platform-data-manage/references/bulk-operations-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Bulk Operations Guide, 벌크 작업 가이드, Bulk API 2.0, sf data import bulk]
---

# Bulk Operations Guide — 벌크 작업 가이드

> 레코드 건수별로 적합한 API를 고르고 Bulk API 2.0 명령(import/update/upsert/delete/export)을 사용하는 방법.
