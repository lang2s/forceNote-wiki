...
source: forcedotcom/sf-skills (skills/platform-data-manage/references/cleanup-rollback-example.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Cleanup and Rollback Examples, 정리 및 롤백 예제, ID 추적 정리, testSetup 격리]
---

# Cleanup and Rollback Examples — 정리 및 롤백 예제

> 테스트 데이터 격리·정리의 5가지 방법(Savepoint, 이름 패턴, 시간 창, ID 추적, @testSetup)과 sf CLI 벌크 삭제 전체 예제.
