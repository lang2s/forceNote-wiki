---
tags: [agent-skill, sf-skills, reference, platform, data, orchestration]
source: forcedotcom/sf-skills (skills/platform-data-manage/references/orchestration.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Multi-Skill Orchestration, 멀티 스킬 오케스트레이션, platform-data-manage 순서, 251 레코드 패턴]
---

# Multi-Skill Orchestration: platform-data-manage Perspective — 멀티 스킬 오케스트레이션 (platform-data-manage 관점)

> platform-data-manage가 멀티 스킬 워크플로우에서 항상 마지막에 오는 이유와 다른 스킬과의 교차 통합·정리 시퀀스.
