---
tags: [agent-skill, sf-skills, reference, platform, data, test-data]
source: forcedotcom/sf-skills (skills/platform-data-manage/references/test-data-best-practices.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Test Data Best Practices, 테스트 데이터 모범 사례, describe-first, 사전 검증 체크리스트]
---

# Test Data Best Practices — 테스트 데이터 모범 사례

> describe 우선 규칙, CLI 우선 CRUD, 사전 점검 체크리스트, 실패 패턴 표, 제한적 재시도 전략과 수동 대체 옵션.
