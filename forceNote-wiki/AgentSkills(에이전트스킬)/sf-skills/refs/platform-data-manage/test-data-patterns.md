...
source: forcedotcom/sf-skills (skills/platform-data-manage/references/test-data-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Test Data Patterns Guide, 테스트 데이터 패턴, Factory 패턴, 레코드 건수 권장]
---

# Test Data Patterns Guide — 테스트 데이터 패턴 가이드

> Factory 패턴 표준 구현, 시나리오별 레코드 건수 권장표, 엣지 케이스(널/경계/특수문자/날짜)와 관계 테스트 모범 사례.
