...
source: forcedotcom/sf-skills (skills/platform-data-manage/references/relationship-query-examples.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Relationship Query Examples, 관계 쿼리 예제, 집계 쿼리, 세미조인 안티조인, 다형성 TYPEOF]
---

# Relationship Query Examples — 관계 쿼리 예제

> 복잡한 데이터 조회를 위한 SOQL 관계 패턴 전수 — 서브쿼리, 점 표기, TYPEOF 다형성, 집계, 세미/안티조인, 날짜 함수, 최적화 팁.
