---
tags: [agent-skill, sf-skills, reference, platform, data, sf-cli]
source: forcedotcom/sf-skills (skills/platform-data-manage/references/sf-cli-data-commands.md, 공식 Salesforce)
created: 2026-06-27
aliases: [sf CLI Data Commands, sf 데이터 명령 레퍼런스, sf data query, sObject describe]
---

# sf CLI Data Commands Reference — sf CLI 데이터 명령 레퍼런스

> Salesforce CLI v2의 data 명령(query/record/bulk/tree)과 describe 사전 검증 jq 필터 전체 레퍼런스.
