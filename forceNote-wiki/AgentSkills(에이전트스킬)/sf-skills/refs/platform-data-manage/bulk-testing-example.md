---
tags: [agent-skill, sf-skills, reference, platform, data, bulk-testing]
source: forcedotcom/sf-skills (skills/platform-data-manage/references/bulk-testing-example.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Bulk Testing Example, 벌크 테스트 예제, 251 레코드 패턴, 트리거 벌크화 테스트]
---

# Bulk Testing Example — 벌크 테스트 예제

> 트리거·플로우를 201개 이상(251개) 레코드로 벌크 테스트하는 3가지 방법(익명 Apex/CSV/트리)과 거버너 한도 모니터링.
