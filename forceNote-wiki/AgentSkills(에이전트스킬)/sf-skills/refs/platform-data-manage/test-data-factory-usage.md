---
tags: [agent-skill, sf-skills, reference, platform, data, test-data-factory]
source: forcedotcom/sf-skills (skills/platform-data-manage/references/test-data-factory-usage.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Test Data Factory Usage, 테스트 데이터 팩토리 사용법, Factory 템플릿, 계층 팩토리]
---

# Test Data Factory Usage — 테스트 데이터 팩토리 사용법

> 테스트 데이터 팩토리 템플릿 활용·커스터마이즈 방법 — 기본/변형/관계/계층/엣지 케이스 팩토리와 트리거·플로우 테스트 적용 예제.
