---
tags: [agent-skill, sf-skills, reference, platform, soql, anti-patterns]
source: forcedotcom/sf-skills (skills/platform-soql-query/references/anti-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [SOQL Anti-Patterns, SOQL 안티패턴, 피해야 할 SOQL, 비선택적 쿼리, SOQL in loop]
---
# SOQL Anti-Patterns: What to Avoid — 피해야 할 SOQL 패턴

> SOQL에서 거버너 한도·성능·유지보수성을 해치는 10가지 흔한 실수와 각각의 해결책 카탈로그.
