---
tags: [agent-skill, sf-skills, reference, platform, soql, cli]
source: forcedotcom/sf-skills (skills/platform-soql-query/references/cli-commands.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Salesforce CLI SOQL Commands, sf data query, SOQL CLI 명령어, 벌크 익스포트, 쿼리 플랜 CLI]
---
# Salesforce CLI SOQL Commands — Salesforce CLI SOQL 명령어

> `sf data query`를 중심으로 한 SOQL 실행·출력 포맷·벌크 익스포트·쿼리 플랜 분석·Tooling API·스크립트 통합 명령어 레퍼런스.
