---
tags: [agent-skill, sf-skills, reference, platform, soql, optimization]
source: forcedotcom/sf-skills (skills/platform-soql-query/references/query-optimization.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Query Optimization, 쿼리 최적화, 거버너 한도, Governor Limits, 인덱싱 전략, selectivity]
---
# Query Optimization & Governor Limits — 쿼리 최적화와 거버너 한도

> 인덱싱 전략·선택성 규칙·쿼리 플랜 분석·거버너 한도·SOQL for 루프·보안 패턴을 다루는 SOQL 성능 가이드.
