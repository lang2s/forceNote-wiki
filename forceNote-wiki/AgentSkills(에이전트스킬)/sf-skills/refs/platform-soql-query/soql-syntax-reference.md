---
tags: [agent-skill, sf-skills, reference, platform, soql, syntax]
source: forcedotcom/sf-skills (skills/platform-soql-query/references/soql-syntax-reference.md, 공식 Salesforce)
created: 2026-06-27
aliases: [SOQL Syntax Reference, SOQL 문법 참조, GROUP BY ROLLUP, TYPEOF, semi-join, FORMAT, convertCurrency]
---
# SOQL Syntax Reference — SOQL 문법 참조

> 기본 쿼리 구조부터 관계 쿼리·집계(GROUP BY/HAVING/ROLLUP)·다형성 관계(TYPEOF)·세미조인/안티조인·FORMAT/convertCurrency까지 다루는 SOQL 문법 가이드.
