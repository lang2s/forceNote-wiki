---
tags: [agent-skill, sf-skills, reference, platform, soql, quick-reference]
source: forcedotcom/sf-skills (skills/platform-soql-query/references/soql-reference.md, 공식 Salesforce)
created: 2026-06-27
aliases: [SOQL Quick Reference, SOQL 빠른 참조, 연산자, 날짜 리터럴, 집계 함수, 거버너 한도]
---
# SOQL Quick Reference — SOQL 빠른 참조

> 쿼리 구조·연산자·날짜 리터럴·집계/날짜 함수·관계 쿼리·WITH 절·거버너 한도·인덱스·CLI를 한 페이지로 정리한 SOQL 치트시트.
...
- [[platform-soql-query/cli-commands|cli-commands]]
