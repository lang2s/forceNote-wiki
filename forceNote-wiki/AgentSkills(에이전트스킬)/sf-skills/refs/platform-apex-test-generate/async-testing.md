---
tags: [agent-skill, sf-skills, reference, platform, apex-test, async]
source: forcedotcom/sf-skills (skills/platform-apex-test-generate/references/async-testing.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Async Testing Patterns, Batch test, Queueable test, 비동기 테스트, 스케줄 Apex 테스트, future method test]
---
# Async Testing Patterns — Apex 비동기 테스트 패턴

> `Test.stopTest()`로 비동기 실행을 강제하는 원리와 Batch·Queueable·Future·Scheduled Apex 테스트 패턴 및 흔한 함정.
