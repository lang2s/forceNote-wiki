---
tags: [agent-skill, sf-skills, reference, platform, apex-test, assertions]
source: forcedotcom/sf-skills (skills/platform-apex-test-generate/references/assertion-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Assertion Patterns, Assert class, 어서션 패턴, 단언문, 테스트 검증]
---
# Assertion Patterns — Apex 어서션(단언) 패턴

> `Assert` 클래스 메서드 사용법, 좋은 vs 나쁜 어서션, 컬렉션/필드/예외/DML/Null/날짜 검증 패턴과 안티패턴.
