...
source: forcedotcom/sf-skills (skills/platform-apex-test-generate/references/mocking-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Mocking Patterns generate, HttpCalloutMock, SOSL mocking, StubProvider, 모킹 패턴 생성, 이메일 테스트, 플랫폼 이벤트 테스트]
---
# Mocking Patterns — Apex 테스트 모킹 패턴 (test-generate)

> HTTP 콜아웃·SOSL·DML(생성자 주입)·Stub API·이메일·플랫폼 이벤트를 테스트에서 모킹하는 패턴 모음 (platform-apex-test-generate 관점).
