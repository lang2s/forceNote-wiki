---
tags: [agent-skill, sf-skills, reference, slds, design-system, quality-checks]
source: forcedotcom/sf-skills (skills/design-systems-slds-validate/references/quality-checks.md, 공식 Salesforce)
created: 2026-06-27
aliases: [SLDS Quality Checks Reference, SLDS 품질 검사 레퍼런스, theming accessibility code quality checks, 스코어링]
---

# SLDS Quality Checks Reference — SLDS 품질 검사 레퍼런스

> SLDS 컴포넌트 검증 시 수행하는 품질 검사 전체 카탈로그(테마·접근성·코드품질·컴포넌트사용). 린터가 못 잡는 검사 위주로, 탐지 방식(Script/Linter/Manual)·심각도·통과 기준·정규식 패턴·스코어링 공식 포함.
