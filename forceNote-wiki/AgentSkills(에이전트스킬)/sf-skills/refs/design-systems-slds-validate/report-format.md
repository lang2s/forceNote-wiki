---
tags: [agent-skill, sf-skills, reference, slds, design-system, report-format]
source: forcedotcom/sf-skills (skills/design-systems-slds-validate/references/report-format.md, 공식 Salesforce)
created: 2026-06-27
aliases: [SLDS Quality Report Format, SLDS 품질 리포트 포맷, compact full report, scorecard, JSON output]
---

# SLDS Quality Report Format — SLDS 품질 리포트 포맷

> 품질 리포트 생성 가이드라인. 기본은 compact 스코어카드, 사용자가 상세를 요청하면 full 리포트로 확장. JSON 출력·상태 표시·등급 설명·전달 가이드라인 포함.
