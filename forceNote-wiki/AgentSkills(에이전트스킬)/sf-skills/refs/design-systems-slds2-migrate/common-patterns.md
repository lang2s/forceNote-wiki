---
tags: [agent-skill, sf-skills, reference, slds, design-system, migration-patterns]
source: forcedotcom/sf-skills (skills/design-systems-slds2-migrate/references/common-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Common Patterns, 공통 패턴, SLDS2 마이그레이션 패턴, deprecated classes, palette fallbacks]
---

# Common Patterns — SLDS 2 마이그레이션 공통 패턴

> SLDS 2 마이그레이션에서 자주 마주치는 deprecated 클래스 제거, palette 훅 RGB fallback, SLDS 2 대응 훅이 없는 토큰, 커스텀 훅 네임스페이스, 폰트 패밀리 후처리 정리 패턴 모음.
