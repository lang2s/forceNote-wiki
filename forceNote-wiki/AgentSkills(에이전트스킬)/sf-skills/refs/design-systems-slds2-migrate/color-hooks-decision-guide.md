---
tags: [agent-skill, sf-skills, reference, slds, design-system, color-hooks]
source: forcedotcom/sf-skills (skills/design-systems-slds2-migrate/references/color-hooks-decision-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Color Hooks Decision Guide, 컬러 훅 결정 가이드, SLDS2 색상 훅, surface accent feedback palette]
---

# Color Hooks Decision Guide — SLDS 2 색상 훅 선택 가이드

> 하드코딩된 색상을 SLDS 2 색상 훅으로 교체할 때, 또는 린터가 여러 후보를 제안할 때 surface·accent·feedback·palette·system 훅 중 올바른 것을 고르는 의사결정 레퍼런스.
