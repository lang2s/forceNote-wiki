---
tags: [agent-skill, sf-skills, reference, slds, design-system, migration-examples]
source: forcedotcom/sf-skills (skills/design-systems-slds2-migrate/references/examples.md, 공식 Salesforce)
created: 2026-06-27
aliases: [SLDS Migration Examples, SLDS 마이그레이션 예제, before after, 위반 유형별 예시]
---

# SLDS Migration Examples — 위반 유형별 Before/After 예제

> 클래스 오버라이드·LWC 토큰·하드코딩 값·Aura t() 토큰·deprecated 클래스 제거·color-mix·calc 등 SLDS 2 마이그레이션 위반 유형별 before/after 변환 예제 모음.
