---
tags: [agent-skill, sf-skills, reference, platform, debug, debug-log]
source: forcedotcom/sf-skills (skills/platform-apex-logs-debug/references/debug-log-reference.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Salesforce Debug Log Reference, 디버그 로그 레퍼런스, 로그 이벤트, SOQL_EXECUTE_BEGIN, LIMIT_USAGE, FATAL_ERROR, 로그 레벨]
---
# Salesforce Debug Log Reference — Salesforce 디버그 로그 레퍼런스

> 디버그 로그 구조·이벤트 카테고리(실행/SOQL/DML/한도/예외/메서드/루프/콜아웃/힙)·로그 레벨·거버너 한도·흔한 로그 패턴·분석 체크리스트.
