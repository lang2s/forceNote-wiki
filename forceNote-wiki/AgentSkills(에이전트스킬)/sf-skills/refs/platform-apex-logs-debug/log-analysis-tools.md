---
tags: [agent-skill, sf-skills, reference, platform, debug, tools]
source: forcedotcom/sf-skills (skills/platform-apex-logs-debug/references/log-analysis-tools.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Log Analysis Tools, 로그 분석 도구, Apex Log Analyzer, flame chart, Developer Console, ripgrep 로그 분석]
---
# Log Analysis Tools — 로그 분석 도구

> Apex 디버그 로그 분석 도구 가이드 — VS Code Apex Log Analyzer(flame chart), SF CLI 디버그 명령, grep/ripgrep 수동 분석, Developer Console, 도구 비교.
