---
tags: [agent-skill, sf-skills, reference, platform, debug, cli]
source: forcedotcom/sf-skills (skills/platform-apex-logs-debug/references/cli-commands.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Salesforce CLI Debug Commands, sf apex log, 디버그 CLI 명령어, TraceFlag, DebugLevel, 로그 조회]
---
# Salesforce CLI Debug Commands Reference — Salesforce CLI 디버그 명령어 레퍼런스

> `sf apex list/get/tail log`, TraceFlag·DebugLevel 설정, grep 기반 로그 분석, 자동화 스크립트, 트러블슈팅을 다루는 디버그 CLI 레퍼런스.
