---
tags: [agent-skill, sf-skills, reference, platform, debug, benchmarking]
source: forcedotcom/sf-skills (skills/platform-apex-logs-debug/references/benchmarking-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Apex Benchmarking Guide, Apex 벤치마킹, 성능 측정, String.join, 루프 성능, 거버너 한도 임계값]
---
# Apex Benchmarking Guide — Apex 벤치마킹 가이드

> Anonymous Apex 기반 신뢰성 있는 성능 측정 기법, 실제 벤치마크 결과(String 연결 vs String.join, 루프 유형, Map/List 조회), 거버너 한도 임계값과 런타임 체크.
