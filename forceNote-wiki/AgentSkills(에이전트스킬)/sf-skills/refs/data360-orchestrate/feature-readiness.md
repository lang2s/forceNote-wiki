---
tags: [agent-skill, sf-skills, reference, data-cloud, data360, troubleshooting, feature-gate]
source: forcedotcom/sf-skills (skills/data360-orchestrate/references/feature-readiness.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Data Cloud Feature Readiness, 데이터클라우드 기능 준비 상태, data360 feature gate, signal matrix]
---
# Data Cloud Feature Readiness — 데이터 클라우드 기능 준비 상태 진단

> Data Cloud 명령이 실패할 때 런타임/플러그인·org 인증·프로비저닝·기능 게이팅·빈-활성 상태·잘못된 테이블명 중 무엇이 원인인지 "탐지 → 분류 → 안내" 순으로 판별하는 가이드.
