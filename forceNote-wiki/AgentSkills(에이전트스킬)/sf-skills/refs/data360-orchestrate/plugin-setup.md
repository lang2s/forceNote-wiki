---
tags: [agent-skill, sf-skills, reference, data-cloud, data360, plugin-setup, cli]
source: forcedotcom/sf-skills (skills/data360-orchestrate/references/plugin-setup.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Data Cloud Community Plugin Setup, data360 플러그인 설치, sf data360 runtime, bootstrap-plugin]
---
# Data Cloud Community Plugin Setup — 데이터 클라우드 커뮤니티 플러그인 설정

> data360-orchestrate 패밀리가 사용하는 커뮤니티 `sf data360` CLI 런타임의 설치·검증·문제 해결 가이드(sf-skills는 이 플러그인을 vendor/fork 하지 않음).

---

The data360-orchestrate family uses a **community `sf data360` CLI runtime**. sf-skills does not vendor or fork that plugin.
...
For STDM/session tracing/parquet work, use `agentforce-observe` instead of this plugin-focused family.
