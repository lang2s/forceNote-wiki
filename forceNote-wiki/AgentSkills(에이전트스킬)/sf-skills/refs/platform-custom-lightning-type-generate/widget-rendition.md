...
source: forcedotcom/sf-skills (skills/platform-custom-lightning-type-generate/references/widget-rendition.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Widget Generation Guide, 위젯 렌디션 생성, mosaic rendition, UEM tree, discoverUiComponents]
---
# Widget Generation Guide — 위젯 렌디션 생성 가이드

> CLT(Custom Lightning Type)용 mosaic 렌디션(위젯) 생성 가이드. UEM 트리 구성·스키마 그라운딩·메타데이터 액션·플레이스홀더 바인딩·워크플로우.
