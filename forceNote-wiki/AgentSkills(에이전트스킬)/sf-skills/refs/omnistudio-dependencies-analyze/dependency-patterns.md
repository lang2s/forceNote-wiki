...
source: forcedotcom/sf-skills (skills/omnistudio-dependencies-analyze/references/dependency-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [OmniStudio dependency patterns, 옴니스튜디오 의존성 패턴, 의존성 그래프, 순환 의존성, 영향도 분석]
---

# OmniStudio Dependency Patterns — OmniStudio 의존성 패턴

> OmniStudio 컴포넌트 의존성 방향, PropertySetConfig/Definition 파싱 추출 규칙, 순환 의존성 탐지, 의존성 그래프 구성·영향도 분석.
