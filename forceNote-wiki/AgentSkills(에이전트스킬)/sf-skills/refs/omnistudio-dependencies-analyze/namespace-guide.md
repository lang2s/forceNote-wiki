---
tags: [agent-skill, sf-skills, reference, omnistudio, dependencies]
source: forcedotcom/sf-skills (skills/omnistudio-dependencies-analyze/references/namespace-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [OmniStudio namespace guide, 옴니스튜디오 네임스페이스, Core vlocity_cmt vlocity_ins, 객체·필드 매핑, SOQL]
---

# OmniStudio Namespace Reference Guide — OmniStudio 네임스페이스 레퍼런스 가이드

> Core / vlocity_cmt / vlocity_ins 세 네임스페이스 탐지 알고리즘, 객체·필드 매핑, 메타데이터 타입, 혼합 네임스페이스 시나리오, SOQL 인벤토리 템플릿.
