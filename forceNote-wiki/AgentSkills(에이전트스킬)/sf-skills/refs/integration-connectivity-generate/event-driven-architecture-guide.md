---
tags: [agent-skill, sf-skills, reference, integration, event-driven-architecture]
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/references/event-driven-architecture-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Event-Driven Architecture, 이벤트 기반 아키텍처, EDA, Pub/Sub API]
---

# Event-Driven Architecture Guide — 이벤트 기반 아키텍처 가이드

> 5대 EDA 패턴, Pub/Sub API, Event Relay·Kafka, 이벤트를 쓰지 말아야 할 경우, 모니터링·결정 트리를 다룬다.
