...
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/references/named-credentials-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Named Credentials, 명명된 자격 증명, External Credentials, callout 인증]
---

# Named Credentials Guide — 명명된 자격 증명 가이드

> 외부 시스템 인증을 안전하게 저장하는 Named Credentials와 External Credentials(API 61+)의 인증 타입·모범 사례·마이그레이션을 다룬다.
