---
tags: [agent-skill, sf-skills, reference, integration, external-services]
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/assets/external-services/external-service-operations.md, 공식 Salesforce)
created: 2026-06-27
aliases: [External Service Operations, 외부 서비스 작업, OpenAPI Operations, Generated Apex]
---

# External Service Operations Guide — 외부 서비스 작업 가이드

> External Service가 생성한 Apex 클래스 구조와 GET/POST/PUT/PATCH/DELETE 작업 호출·오류처리·비동기 패턴·한도를 다룬다.
