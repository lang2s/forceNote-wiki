---
tags: [agent-skill, sf-skills, reference, integration, callout]
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/references/callout-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Callout Patterns, 콜아웃 패턴, REST SOAP 콜아웃, Queueable Callout]
---

# Callout Patterns Reference — 콜아웃 패턴 레퍼런스

> Salesforce 통합에서 REST·SOAP 콜아웃을 구현하는 상세 패턴(동기/비동기 Queueable, 재시도, WSDL2Apex)을 다룬다.
