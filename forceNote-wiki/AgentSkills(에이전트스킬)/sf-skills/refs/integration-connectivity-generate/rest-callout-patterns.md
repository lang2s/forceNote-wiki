...
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/references/rest-callout-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [REST Callout Patterns, REST 콜아웃 패턴, HTTP Apex, HttpRequest]
---

# REST Callout Patterns — REST 콜아웃 패턴

> Apex에서 외부 REST API로 HTTP 콜아웃을 보내는 동기/비동기·오류처리·재시도·페이지네이션·테스트 패턴을 다룬다.
