...
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/references/security-best-practices.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Security Best Practices, 보안 모범 사례, 통합 보안, Integration Security]
---

# Integration Security Best Practices — 통합 보안 모범 사례

> 통합 보안: 자격 증명 관리·OAuth·네트워크·입력 검증·오류처리·사용자 컨텍스트·플랫폼 이벤트 보안·컴플라이언스 체크리스트.
...
- [[integration-connectivity-generate/scoring-rubric|scoring-rubric]]
