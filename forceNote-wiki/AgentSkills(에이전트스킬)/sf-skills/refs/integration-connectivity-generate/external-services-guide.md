...
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/references/external-services-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [External Services, 외부 서비스, OpenAPI Apex, ExternalServiceRegistration]
---

# External Services Guide — 외부 서비스 가이드

> OpenAPI(Swagger) 스펙으로부터 타입세이프 Apex 클래스를 자동 생성하는 External Services의 등록·사용·Agentforce 연동을 다룬다.
