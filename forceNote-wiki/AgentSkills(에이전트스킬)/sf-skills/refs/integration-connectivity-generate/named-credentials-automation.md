---
tags: [agent-skill, sf-skills, reference, integration, named-credentials]
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/references/named-credentials-automation.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Named Credentials Automation, 명명된 자격 증명 자동화, ConnectApi NamedCredentials, Enhanced Named Credential]
---

# Named Credentials Automation Guide — 명명된 자격 증명 자동화 가이드

> Enhanced Named Credentials(API 60+)를 ConnectApi로 UI 없이 자동 구성하는 헬퍼 스크립트와 배포 순서를 다룬다.

---

This guide explains how to automate Named Credential configuration using the integration-connectivity-generate helper scripts.
