---
tags: [agent-skill, sf-skills, reference, integration, messaging]
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/references/messaging-api-v2.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Messaging API v2, 메시징 API, MIAW, Messaging for In-App and Web]
---

# Messaging API v2 Guide (MIAW) — 메시징 API v2 가이드

> Messaging for In-App and Web(MIAW) 커스텀 클라이언트 구축: JWT 인증·대화 라이프사이클·메시지 타입·React 통합·배포를 다룬다.
...
| Agentforce agents | [agentforce-generate skill](../../agentforce-generate/SKILL.md) |
