---
tags: [agent-skill, sf-skills, reference, integration, event]
source: forcedotcom/sf-skills (skills/integration-connectivity-generate/references/event-patterns.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Event Patterns, 이벤트 패턴, Platform Events CDC, EventBus.publish]
---

# Event-Driven Integration Patterns — 이벤트 기반 통합 패턴

> Platform Events와 Change Data Capture의 정의·발행·구독·필드 변경 감지·안티패턴·테스트 구현 패턴을 다룬다.
