---
tags: [agent-skill, sf-skills, reference, integration, security]
source: forcedotcom/sf-skills (skills/integration-connectivity-connected-app-configure/references/security-checklist.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Connected App Security Checklist, 커넥티드 앱 보안 체크리스트, OAuth 보안 점검, ECA 보안]
---

# Security Checklist for Connected Apps & ECAs — 커넥티드 앱·ECA 보안 체크리스트

> 프로덕션 배포 전 OAuth 앱(Connected App·External Client App)에 적용하는 보안 점검 항목·스코어링 기준·스코프/IP 정책·인증서 관리·사고 대응 절차.
