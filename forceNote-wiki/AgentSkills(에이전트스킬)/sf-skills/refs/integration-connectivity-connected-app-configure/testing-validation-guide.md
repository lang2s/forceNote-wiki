---
tags: [agent-skill, sf-skills, reference, integration, deployment]
source: forcedotcom/sf-skills (skills/integration-connectivity-connected-app-configure/references/testing-validation-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [ECA Testing Validation Guide, ECA 테스트 검증 가이드, ECA 파일 명명 규칙, ECA 배포 오류]
---

# Testing & Validation Guide — ECA·커넥티드 앱 테스트·검증 가이드

> 검증 테스트 기반 ECA·Connected App 패턴, 메타데이터 파일 명명 규칙, 배포 오류·해결책, 필드 레퍼런스, 배포 순서·체크리스트.
