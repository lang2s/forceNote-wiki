---
tags: [agent-skill, sf-skills, reference, integration, connected-app]
source: forcedotcom/sf-skills (skills/integration-connectivity-connected-app-configure/references/example-usage.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Connected App Examples, 커넥티드 앱 예제, External Client App 예제, ECA 생성 예제]
---

# integration-connectivity-connected-app-configure Examples — 커넥티드 앱 구성 예제

> Connected App·External Client App(ECA)을 생성·검토·마이그레이션하는 실제 요청/생성물 예제와 배포 명령어 모음.
