---
tags: [agent-skill, sf-skills, reference, integration, oauth]
source: forcedotcom/sf-skills (skills/integration-connectivity-connected-app-configure/references/oauth-flows-reference.md, 공식 Salesforce)
created: 2026-06-27
aliases: [OAuth Flows Reference, OAuth 플로우 레퍼런스, JWT Bearer, PKCE, Device Authorization, Client Credentials]
---

# OAuth Flows Reference for Connected Apps — 커넥티드 앱 OAuth 플로우 레퍼런스

> Authorization Code·PKCE·JWT Bearer·Device·Client Credentials 등 OAuth 플로우별 선택 기준·구성 예제·구현 패턴·보안 체크리스트·에러 처리.
