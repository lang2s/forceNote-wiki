---
tags: [agent-skill, sf-skills, reference, integration, migration]
source: forcedotcom/sf-skills (skills/integration-connectivity-connected-app-configure/references/migration-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Connected App to ECA Migration, 커넥티드 앱 마이그레이션, External Client App 전환, ECA 마이그레이션]
---

# Migration Guide: Connected App → External Client App — 커넥티드 앱 → ECA 마이그레이션 가이드

> Connected App을 External Client App(ECA)으로 전환하는 7단계 절차(평가·계획·생성·통합 업데이트·테스트·컷오버·폐기)와 롤백·자동화 스크립트.
