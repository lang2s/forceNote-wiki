...
source: forcedotcom/sf-skills (skills/omnistudio-datamapper-generate/references/naming-conventions.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Data Mapper naming, 데이터매퍼 명명 규칙, DR_ 접두사, DataRaptor]
---

# Data Mapper Naming Conventions — Data Mapper 명명 규칙

> Data Mapper 유형 접두사(DR_Extract_ 등), 객체·필드 매핑 명명 패턴, 안티패턴, 환경 비종속 명명, 문자 제한.
