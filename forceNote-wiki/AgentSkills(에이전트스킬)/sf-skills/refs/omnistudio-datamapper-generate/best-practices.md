...
source: forcedotcom/sf-skills (skills/omnistudio-datamapper-generate/references/best-practices.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Data Mapper best practices, 데이터매퍼 모범사례, Extract Turbo Transform Load, 필드 매핑, 관계 쿼리]
---

# Data Mapper Best Practices — Data Mapper 모범 사례

> Data Mapper 유형 선택(Extract/Turbo/Transform/Load), 필드 매핑·쿼리 시퀀스 최적화, null 처리, 관계 쿼리, 대용량 성능 가이드.
...
- [[omnistudio-datamapper-generate/naming-conventions|naming-conventions]]
