---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, quote-order]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/quote-order-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Quote and Order Data Model Template, 견적 주문 데이터 모델 템플릿, Quote Order Pricebook PricebookEntry ERD]
---

# Quote & Order Data Model Template — 견적·주문 데이터 모델 템플릿

> Opportunity·Quote·QuoteLineItem·Order·OrderItem·Product2·PricebookEntry·Contract 등 Salesforce 견적·주문 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
