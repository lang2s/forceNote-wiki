...
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/oauth/authorization-code.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Authorization Code Flow Template, 인증 코드 플로우 템플릿, OAuth Authorization Code]
---

# Authorization Code Flow Template — 인증 코드 플로우 템플릿
> 안전한 백엔드 서버를 가진 웹 애플리케이션(컨피덴셜 클라이언트)을 위한 표준 OAuth 2.0 인증 코드 플로우 시퀀스 다이어그램 템플릿.
