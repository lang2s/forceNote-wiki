---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, examples]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/references/usage-examples.md, 공식 Salesforce)
created: 2026-06-27
aliases: [sf-diagram Usage Examples, sf-diagram 사용 예제, 다이어그램 생성 예시]
---

# sf-diagram Usage Examples — sf-diagram 사용 예제
> OAuth 플로우·데이터 모델 ERD·통합 시퀀스 등 sf-diagram 스킬의 실제 요청-출력-채점 예제 모음.
