...
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/oauth/refresh-token.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Refresh Token Flow Template, 리프레시 토큰 플로우 템플릿, OAuth Refresh Token]
---

# Refresh Token Flow Template — 리프레시 토큰 플로우 템플릿
> 사용자 재인증 없이 새 액세스 토큰을 발급받는 OAuth 2.0 리프레시 토큰 그랜트 시퀀스 다이어그램 템플릿.
