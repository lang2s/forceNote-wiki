---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, b2b-commerce]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/b2b-commerce-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [B2B Commerce Data Model Template, B2B 커머스 데이터 모델 템플릿, WebStore WebCart BuyerGroup Entitlement ERD]
---

# B2B Commerce Data Model Template — B2B 커머스 데이터 모델 템플릿

> WebStore·WebCart·CartItem·BuyerGroup·BuyerAccount·CommerceEntitlement 등 Salesforce B2B Commerce 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
