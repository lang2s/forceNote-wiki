...
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/oauth/jwt-bearer.md, 공식 Salesforce)
created: 2026-06-27
aliases: [JWT Bearer Flow Template, JWT 베어러 플로우 템플릿, OAuth JWT Bearer]
---

# JWT Bearer Flow Template — JWT 베어러 플로우 템플릿
> 사용자 상호작용 없이 서버 간 인증을 수행하는 OAuth 2.0 JWT 베어러 어서션 플로우 시퀀스 다이어그램 템플릿(CI/CD·스케줄 작업·헤드리스).
