---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, color-palette]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/references/color-palette.md, 공식 Salesforce)
created: 2026-06-27
aliases: [sf-diagram Color Palette, sf-diagram 색상 팔레트, Tailwind 파스텔 색상표]
---

# sf-diagram Color Palette — sf-diagram 색상 팔레트
> Tailwind 200-레벨 파스텔 채움 + 어두운 테두리를 사용하는 sf-diagram 표준 색상 팔레트·폰트·간격·아이콘·접근성 규칙 전체 참조.
