---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, role-hierarchy]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/role-hierarchy/user-hierarchy.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Role Hierarchy Diagram Template, 역할 계층 다이어그램 템플릿, 프로필 권한 집합 구조도]
---

# Role Hierarchy Diagram Template — 역할 계층 다이어그램 템플릿
> Salesforce 역할 계층·프로필·권한 집합 구조와 데이터 접근 패턴을 시각화하는 Mermaid 플로우차트 템플릿.
