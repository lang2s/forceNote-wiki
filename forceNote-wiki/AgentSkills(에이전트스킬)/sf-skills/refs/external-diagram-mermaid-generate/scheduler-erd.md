---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, scheduler]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/scheduler-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Salesforce Scheduler Data Model Template, Salesforce 스케줄러 데이터 모델 템플릿, ServiceAppointment ServiceResource WorkType ERD]
---

# Salesforce Scheduler Data Model Template — Salesforce 스케줄러(Lightning Scheduler) 데이터 모델 템플릿

> ServiceAppointment·ServiceResource·ServiceTerritory·WorkType·AssignedResource·ResourceAbsence·TimeSlot 등 Salesforce Scheduler(Lightning Scheduler) 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
