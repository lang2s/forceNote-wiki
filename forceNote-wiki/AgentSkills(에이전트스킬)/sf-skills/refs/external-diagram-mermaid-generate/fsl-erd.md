---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, field-service]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/fsl-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Field Service Lightning Data Model Template, 현장 서비스 데이터 모델 템플릿, WorkOrder ServiceAppointment ServiceResource ERD]
---

# Field Service Lightning (FSL) Data Model Template — 현장 서비스 데이터 모델 템플릿

> WorkOrder·ServiceAppointment·ServiceResource·ServiceTerritory·TimeSheet·Product 등 Salesforce Field Service(구 FSL) 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
