---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, conventions]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/references/diagram-conventions.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Diagram Conventions, 다이어그램 작성 규칙, 시퀀스 ERD 플로우차트 규칙]
---

# Diagram Conventions — 다이어그램 작성 규칙
> sf-diagram이 생성하는 모든 다이어그램(시퀀스·ERD·플로우차트·ASCII)의 일관성 가이드라인과 채점 기준·검증 체크리스트.
...
| Subprocess | Double Rectangle | `&#91;&#91;Subprocess&#93;&#93;` (대괄호 두 쌍) |
