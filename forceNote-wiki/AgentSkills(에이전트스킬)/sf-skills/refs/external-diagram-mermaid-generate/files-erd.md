---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, files]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/files-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Salesforce Files Data Model Template, Salesforce 파일 데이터 모델 템플릿, ContentDocument ContentVersion ContentDocumentLink ERD]
---

# Salesforce Files Data Model Template — Salesforce 파일(Content) 데이터 모델 템플릿

> ContentDocument·ContentVersion·ContentDocumentLink·ContentWorkspace 등 Salesforce Files(Content) 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
