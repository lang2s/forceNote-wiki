---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, integration]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/integration/api-sequence.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Integration Sequence Diagram Template, 통합 시퀀스 다이어그램 템플릿, REST 콜아웃 시퀀스]
---

# Integration Sequence Diagram Template — 통합 시퀀스 다이어그램 템플릿
> Salesforce와 외부 시스템 간 통합 패턴(아웃바운드/인바운드 REST, 플랫폼 이벤트)을 시각화하는 Mermaid 시퀀스 다이어그램 템플릿.
