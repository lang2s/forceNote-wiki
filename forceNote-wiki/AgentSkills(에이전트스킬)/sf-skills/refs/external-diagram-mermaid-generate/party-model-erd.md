---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, industry-cloud]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/party-model-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Party Model Data Model Template, 파티 모델 데이터 모델 템플릿, AccountContactRelation FSC Health Cloud ERD]
---

# Party Model (Industry Cloud) Data Model Template — 파티 모델 데이터 모델 템플릿

> Industry Cloud(Financial Services Cloud·Health Cloud 등)에서 쓰는 Account·Contact·AccountContactRelation·ContactContactRelation·AccountAccountRelation 파티 모델을 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
