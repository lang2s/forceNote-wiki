---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, consent, gdpr]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/consent-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Consent Data Model Template, 동의 GDPR 데이터 모델 템플릿, Individual ContactPoint ConsentManagement ERD]
---

# Consent Data Model Template — 동의(GDPR/Privacy) 데이터 모델 템플릿

> Individual·ContactPoint·DataUsePurpose·ContactPointConsent·CommSubscription 등 Salesforce 동의 관리(GDPR/Privacy) 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
