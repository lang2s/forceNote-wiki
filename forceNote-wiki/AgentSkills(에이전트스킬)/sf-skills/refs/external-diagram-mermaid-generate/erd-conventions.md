---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, erd]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/references/erd-conventions.md, 공식 Salesforce)
created: 2026-06-27
aliases: [ERD Conventions for sf-diagram, ERD 작성 규칙, 데이터 모델 다이어그램 규칙]
---

# ERD Conventions for sf-diagram — ERD 작성 규칙
> 객체 유형 표시·LDV 마커·OWD 주석·관계 유형 라벨을 포함한 Salesforce 데이터 모델 다이어그램 표준 작성 규칙.
