---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, campaigns]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/campaigns-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Campaigns Data Model Template, 캠페인 데이터 모델 템플릿, Campaign CampaignMember CampaignInfluence ERD]
---

# Campaigns Data Model Template — 캠페인 데이터 모델 템플릿

> Campaign·CampaignMember·CampaignInfluence·Lead·Contact·Opportunity 등 Salesforce 캠페인 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
