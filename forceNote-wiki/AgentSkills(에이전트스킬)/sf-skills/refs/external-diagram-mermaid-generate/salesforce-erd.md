---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/salesforce-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Salesforce Data Model Template, Salesforce 데이터 모델 템플릿, ERD flowchart LR object relationships]
---

# Salesforce Data Model Template — Salesforce 데이터 모델 템플릿

> `flowchart LR`로 Salesforce 오브젝트 관계를 색상 코딩·LDV 마커·관계 타입 라벨과 함께 시각화하는 데이터 모델(ERD) 베이스 템플릿. 클라우드별 ERD 템플릿의 허브.
...
- [[system-landscape]]
- erd-conventions (같은 스킬 references, 후반부 배치)
