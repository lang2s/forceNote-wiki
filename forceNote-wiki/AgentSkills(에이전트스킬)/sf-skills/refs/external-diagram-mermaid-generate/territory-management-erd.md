---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, territory-management]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/territory-management-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Territory Management Data Model Template, 지역 관리 데이터 모델 템플릿, Territory2 Enterprise Territory Management ERD]
---

# Territory Management Data Model Template — 지역 관리(Enterprise Territory Management) 데이터 모델 템플릿

> Territory2Model·Territory2·Territory2Type·UserTerritory2Association·ObjectTerritory2Association 등 Salesforce Enterprise Territory Management(Territory2) 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
