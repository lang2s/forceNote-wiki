---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, sales-cloud]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/sales-cloud-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Sales Cloud Data Model Template, Sales Cloud 데이터 모델 템플릿, Account Contact Lead Opportunity ERD]
---

# Sales Cloud Data Model Template — Sales Cloud 데이터 모델 템플릿

> Account·Contact·Lead·Opportunity·Product·Campaign 등 Sales Cloud 핵심 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
