---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, service-cloud]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/service-cloud-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Service Cloud Data Model Template, Service Cloud 데이터 모델 템플릿, Case Entitlement ServiceContract Knowledge ERD]
---

# Service Cloud Data Model Template — Service Cloud 데이터 모델 템플릿

> Account·Contact·Case·Entitlement·ServiceContract·Asset·KnowledgeArticle 등 Salesforce Service Cloud 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
