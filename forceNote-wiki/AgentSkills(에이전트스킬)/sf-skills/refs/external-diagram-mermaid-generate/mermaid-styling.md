---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, styling]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/references/mermaid-styling.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Mermaid Styling Guide, Mermaid 스타일링 가이드, sf-skills 다이어그램 스타일]
---

# Mermaid Styling Guide (sf-skills Standard) — Mermaid 스타일링 가이드
> Tailwind 200-레벨 파스텔 채움 + 어두운 테두리로 일관된 다이어그램을 만드는 sf-skills 표준 스타일링·간격·색상 팔레트 가이드.
