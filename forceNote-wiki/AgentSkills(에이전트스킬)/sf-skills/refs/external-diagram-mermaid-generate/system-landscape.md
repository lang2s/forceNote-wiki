---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, architecture]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/architecture/system-landscape.md, 공식 Salesforce)
created: 2026-06-27
aliases: [System Landscape Diagram Template, 시스템 랜드스케이프 다이어그램, integration landscape architecture overview]
---

# System Landscape Diagram Template — 시스템 랜드스케이프 다이어그램 템플릿

> sf-skills 표준 스타일링으로 고수준 Salesforce 시스템 아키텍처(사용자·플랫폼·통합 레이어·외부 시스템)를 Mermaid flowchart로 시각화하는 템플릿.
