...
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/oauth/device-authorization.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Device Authorization Flow Template, 디바이스 인증 플로우 템플릿, OAuth Device Flow]
---

# Device Authorization Flow Template — 디바이스 인증 플로우 템플릿
> 브라우저가 없거나 입력이 제한된 디바이스(CLI·스마트TV·IoT)를 위한 OAuth 2.0 디바이스 인증 그랜트 시퀀스 다이어그램 템플릿.
