---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, forecasting]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/forecasting-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Forecasting Data Model Template, 예측 데이터 모델 템플릿, ForecastingItem ForecastingQuota OpportunitySplit ERD]
---

# Forecasting Data Model Template — 예측(Collaborative Forecasts) 데이터 모델 템플릿

> ForecastingType·ForecastingItem·ForecastingQuota·ForecastingAdjustment·Opportunity·OpportunitySplit 등 Salesforce Collaborative Forecasts 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
