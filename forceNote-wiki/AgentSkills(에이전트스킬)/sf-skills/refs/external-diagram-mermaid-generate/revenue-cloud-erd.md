---
tags: [agent-skill, sf-skills, reference, diagram, mermaid, datamodel, revenue-cloud]
source: forcedotcom/sf-skills (skills/external-diagram-mermaid-generate/assets/datamodel/revenue-cloud-erd.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Revenue Cloud Data Model Template, Revenue Cloud 데이터 모델 템플릿, CPQ Billing Subscription ERD]
---

# Revenue Cloud Data Model Template — Revenue Cloud 데이터 모델 템플릿

> Revenue Cloud(CPQ·Billing·Subscription Management)의 ProductCatalog·SellingModel·PriceAdjustment·Attribute 오브젝트 관계를 `flowchart LR`로 시각화하는 사전 제작 데이터 모델 템플릿.
