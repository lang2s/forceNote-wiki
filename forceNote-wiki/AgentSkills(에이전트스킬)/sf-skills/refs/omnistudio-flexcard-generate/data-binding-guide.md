...
source: forcedotcom/sf-skills (skills/omnistudio-flexcard-generate/references/data-binding-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [FlexCard data binding, 플렉스카드 데이터 바인딩, IP 데이터소스, 머지 필드, 조건부 렌더링]
---

# FlexCard Data Binding Guide — FlexCard 데이터 바인딩 가이드

> Integration Procedure 데이터소스 구성, 필드 매핑·머지 필드 문법, 조건부 렌더링, 멀티 데이터소스, 데이터소스 오류 처리.
