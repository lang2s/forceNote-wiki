---
tags: [agent-skill, sf-skills, reference, omnistudio, flexcard]
source: forcedotcom/sf-skills (skills/omnistudio-flexcard-generate/references/scoring-rubric.md, 공식 Salesforce)
created: 2026-06-27
aliases: [FlexCard scoring rubric, 플렉스카드 채점 루브릭, 130점 검증]
---

# FlexCard Scoring Rubric - Breakdown Detail — FlexCard 채점 루브릭(세부 기준)

> 130점 FlexCard 검증의 항목별 채점 기준 — Design/Data Binding/Actions/Styling/Accessibility/Testing/Performance.
...
```
// 구조 예시 — 실제 동작 코드 아님
FlexCard Score: XXX/130
|- Design & Layout:      XX/25
|- Data Binding:         XX/20
|- Actions & Navigation: XX/20
|- Styling:              XX/20
|- Accessibility:        XX/15
|- Testing:              XX/15
|- Performance:          XX/15
...
- [[omnistudio-flexcard-generate/best-practices|best-practices]]
