...
source: forcedotcom/sf-skills (skills/omnistudio-flexcard-generate/references/best-practices.md, 공식 Salesforce)
created: 2026-06-27
aliases: [FlexCard best practices, 플렉스카드 모범사례, 레이아웃 패턴, 데이터소스 최적화, 접근성]
---

# FlexCard Best Practices — FlexCard 모범 사례

> FlexCard 레이아웃 패턴(Single/List/Tabbed/Flyout), 데이터소스 최적화, 액션·SLDS·접근성·성능·차일드 카드 합성 가이드.
...
- [[data-binding-guide]]
- [[omnistudio-flexcard-generate/scoring-rubric|scoring-rubric]]
