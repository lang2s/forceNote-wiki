---
tags: [agent-skill, sf-skills, reference, dx, code-analyzer, diagnostic-flow]
source: forcedotcom/sf-skills (skills/dx-code-analyzer-configure/references/diagnostic-flow.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Diagnostic Flow, 진단 흐름, 깨진 셋업 고치기, scan fails, fix table]
---
# Diagnostic Flow: Fix a Broken Setup — 깨진 셋업 진단 흐름

> 사용자가 "안 된다 / 깨졌다 / 에러난다"고 할 때 따르는 정확한 계층별 진단 절차. 바이너리 탐색·심볼릭 링크·구식 sfdx 우회 같은 시간 낭비 안티패턴을 금지한다.
