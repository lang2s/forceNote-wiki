---
tags: [agent-skill, sf-skills, reference, dx, code-analyzer, troubleshooting]
source: forcedotcom/sf-skills (skills/dx-code-analyzer-configure/references/troubleshooting.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Troubleshooting, 트러블슈팅, 설치 문제, Java 문제, YAML 오류, 성능 문제, ESLint 충돌]
---
# Troubleshooting Code Analyzer Setup — 설치·설정 트러블슈팅

> 설치(sf CLI/플러그인/버전), Java, Node.js, 설정 파일(YAML), 엔진별(PMD·RetireJS·Flow·ApexGuru), 성능 문제에 대한 증상-해결 가이드와 도움 받는 법.
