---
tags: [agent-skill, sf-skills, reference, dx, code-analyzer, engine-prerequisites]
source: forcedotcom/sf-skills (skills/dx-code-analyzer-configure/references/engine-prerequisites.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Engine Prerequisites, 엔진 사전 요구사항, 의존성 설치, Java 11, Node 18, Python 3, ApexGuru 인증]
---
# Engine Prerequisites — 엔진별 사전 요구사항(의존성 설치)

> 각 Code Analyzer 엔진(PMD/CPD/ESLint/RetireJS/Regex/Flow/SFGE/ApexGuru)이 요구하는 의존성과 macOS·Windows·Linux별 설치 명령, 검증 방법, 트러블슈팅, 빠른 셋업 스크립트.
