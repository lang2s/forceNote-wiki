---
tags: [agent-skill, sf-skills, reference, dx, code-analyzer, ci-cd-templates]
source: forcedotcom/sf-skills (skills/dx-code-analyzer-configure/references/ci-cd-templates.md, 공식 Salesforce)
created: 2026-06-27
aliases: [CI/CD Pipeline Templates, CI CD 템플릿, GitHub Actions, Jenkins, GitLab, Bitbucket, quality gate, run-code-analyzer]
---
# CI/CD Pipeline Templates — CI/CD 파이프라인 템플릿

> Code Analyzer를 CI/CD에 통합하는 즉시 사용 가능한 템플릿(GitHub Actions·Jenkins·GitLab·Bitbucket), `forcedotcom/run-code-analyzer@v2` 액션 입력/출력, 품질 게이트 전략, 조합·적응 가이드.
