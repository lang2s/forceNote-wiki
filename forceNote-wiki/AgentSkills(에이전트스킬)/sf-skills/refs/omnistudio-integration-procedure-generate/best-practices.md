...
source: forcedotcom/sf-skills (skills/omnistudio-integration-procedure-generate/references/best-practices.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Integration Procedure best practices, 인티그레이션 프로시저 모범사례, IP vs Flow vs Apex, 오류 처리, 캐싱]
---

# Integration Procedure Best Practices — Integration Procedure 모범 사례

> IP 사용 시점, IP vs Flow vs Apex 결정 프레임워크, 엘리먼트 순서·명명·입출력 계약, 오류 처리·롤백, 캐싱·성능·버전 관리.
...
- [[omnistudio-integration-procedure-generate/element-types|element-types]]
