---
tags: [agent-skill, sf-skills, reference, omnistudio, integration-procedure]
source: forcedotcom/sf-skills (skills/omnistudio-integration-procedure-generate/references/element-types.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Integration Procedure element types, IP 엘리먼트 타입, PropertySetConfig, HTTP Action, Remote Action, 변수 스코프]
---

# Integration Procedure Element Types Reference — IP 엘리먼트 타입 레퍼런스

> IP의 모든 엘리먼트 타입(DataRaptor/Remote/IP/HTTP Action, Conditional/Loop Block, Set Values)과 PropertySetConfig·변수 스코프·데이터 전달 규칙.
...
- [[omnistudio-integration-procedure-generate/best-practices|best-practices]]
