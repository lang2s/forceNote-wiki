---
tags: [agent-skill, sf-skills, reference, mobile, geofencing]
source: forcedotcom/sf-skills (skills/mobile-platform-native-capabilities-integrate/references/geofencing.md, 공식 Salesforce)
created: 2026-06-27
aliases: [GeofencingService, 지오펜싱 서비스, geofence, startMonitoringGeofence, 위치 경계 모니터링]
---

# Geofencing Service — 지오펜싱 서비스

> 모바일 기기의 지오펜싱 기능을 LWC에서 활용하기 위한 API 타입과 메서드의 그라운딩 컨텍스트. 지오펜스를 생성·모니터링하고 진입/이탈 이벤트를 다룬다.
