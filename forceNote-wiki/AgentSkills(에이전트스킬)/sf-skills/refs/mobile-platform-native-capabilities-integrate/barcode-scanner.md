---
tags: [agent-skill, sf-skills, reference, mobile, barcode-scanner]
source: forcedotcom/sf-skills (skills/mobile-platform-native-capabilities-integrate/references/barcode-scanner.md, 공식 Salesforce)
created: 2026-06-27
aliases: [BarcodeScanner, 바코드 스캐너, scan, QR 스캔, barcode types]
---

# Barcode Scanner Service — 바코드 스캐너 서비스

> 모바일 기기의 바코드 스캐닝 기능을 LWC에서 활용하기 위한 API 타입과 메서드의 그라운딩 컨텍스트. 다양한 바코드 심볼로지를 스캔하고 벌크/멀티 스캔, 카메라 옵션 등을 구성한다.
