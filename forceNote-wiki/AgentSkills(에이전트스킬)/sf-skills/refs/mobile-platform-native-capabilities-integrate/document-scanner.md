---
tags: [agent-skill, sf-skills, reference, mobile, document-scanner]
source: forcedotcom/sf-skills (skills/mobile-platform-native-capabilities-integrate/references/document-scanner.md, 공식 Salesforce)
created: 2026-06-27
aliases: [DocumentScanner, 문서 스캐너, OCR, 텍스트 인식, entity extraction, 엔티티 추출]
---

# Document Scanner Service — 문서 스캐너 서비스

> 모바일 기기의 문서 스캐닝 기능을 LWC에서 활용하기 위한 API 타입과 메서드의 그라운딩 컨텍스트. 텍스트 인식(OCR), 블록/라인/엘리먼트 구조, 엔티티 추출을 다룬다.
