---
tags: [agent-skill, sf-skills, reference, mobile, contacts]
source: forcedotcom/sf-skills (skills/mobile-platform-native-capabilities-integrate/references/contacts.md, 공식 Salesforce)
created: 2026-06-27
aliases: [ContactsService, 연락처 서비스, getContacts, putContact, 주소록]
---

# Contacts Service — 연락처 서비스

> 모바일 기기의 연락처 기능을 LWC에서 활용하기 위한 API 타입과 메서드의 그라운딩 컨텍스트. 기기 주소록에서 연락처를 선택·가져오거나 새 연락처를 저장한다.
