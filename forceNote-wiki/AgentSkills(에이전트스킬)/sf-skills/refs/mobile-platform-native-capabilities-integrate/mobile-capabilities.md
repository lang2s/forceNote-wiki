---
tags: [agent-skill, sf-skills, reference, mobile, mobile-capabilities]
source: forcedotcom/sf-skills (skills/mobile-platform-native-capabilities-integrate/references/mobile-capabilities.md, 공식 Salesforce)
created: 2026-06-27
aliases: [lightning/mobileCapabilities, 모바일 케이퍼빌리티 모듈, 모바일 하드웨어 API, mobile capabilities module]
---

# lightning/mobileCapabilities — 모바일 케이퍼빌리티 모듈 선언

> 모든 네이티브 케이퍼빌리티 서비스를 재export하는 모듈 선언. LWC를 작성할 때 `lightning/mobileCapabilities`(또는 서비스별 경로)에서 팩토리 함수를 import한다.
