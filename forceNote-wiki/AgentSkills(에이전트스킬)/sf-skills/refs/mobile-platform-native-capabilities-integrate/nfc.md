---
tags: [agent-skill, sf-skills, reference, mobile, nfc]
source: forcedotcom/sf-skills (skills/mobile-platform-native-capabilities-integrate/references/nfc.md, 공식 Salesforce)
created: 2026-06-27
aliases: [NfcService, NFC 서비스, NDEF, read, write, NFC 태그]
---

# NFC Service — NFC 서비스

> 모바일 기기의 NFC 기능을 LWC에서 활용하기 위한 API 타입과 메서드의 그라운딩 컨텍스트. NFC 태그 읽기·쓰기·삭제와 텍스트/URI 레코드 생성을 다룬다.
