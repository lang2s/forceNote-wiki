---
tags: [agent-skill, sf-skills, reference, mobile, location]
source: forcedotcom/sf-skills (skills/mobile-platform-native-capabilities-integrate/references/location.md, 공식 Salesforce)
created: 2026-06-27
aliases: [LocationService, 위치 서비스, getCurrentPosition, startWatchingPosition, 지오로케이션]
---

# Location Service — 위치 서비스

> 모바일 기기의 위치 기능을 LWC에서 활용하기 위한 API 타입과 메서드의 그라운딩 컨텍스트. 현재 위치 조회와 위치 변경 구독(watch)을 다룬다.
