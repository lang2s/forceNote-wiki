---
tags: [agent-skill, sf-skills, reference, mobile, app-review]
source: forcedotcom/sf-skills (skills/mobile-platform-native-capabilities-integrate/references/app-review.md, 공식 Salesforce)
created: 2026-06-27
aliases: [AppReviewService, 앱 리뷰 서비스, requestAppReview, 인앱 리뷰]
---

# App Review Service — 앱 리뷰 서비스

> 모바일 기기의 앱 리뷰 기능을 LWC에서 활용하기 위한 API 타입과 메서드의 그라운딩 컨텍스트. LWC 안에서 인앱 리뷰를 요청할 수 있다.
