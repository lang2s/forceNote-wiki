---
tags: [agent-skill, sf-skills, reference, mobile, calendar]
source: forcedotcom/sf-skills (skills/mobile-platform-native-capabilities-integrate/references/calendar.md, 공식 Salesforce)
created: 2026-06-27
aliases: [CalendarService, 캘린더 서비스, getEvents, addEvent, 반복 이벤트, recurrence rule]
---

# Calendar Service — 캘린더 서비스

> 모바일 기기의 캘린더 기능을 LWC에서 활용하기 위한 API 타입과 메서드의 그라운딩 컨텍스트. 캘린더 조회, 이벤트 조회·추가·수정·삭제와 반복 규칙(recurrence rule)을 다룬다.
