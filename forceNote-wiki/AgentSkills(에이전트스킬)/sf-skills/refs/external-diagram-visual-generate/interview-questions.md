---
tags: [agent-skill, sf-skills, reference, diagram, visual, interview]
source: forcedotcom/sf-skills (skills/external-diagram-visual-generate/references/interview-questions.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Interview Questions Reference, 인터뷰 질문 레퍼런스, AskUserQuestion 질문셋]
---
# Interview Questions Reference — 인터뷰 질문 레퍼런스
> 이미지 생성 전 Claude가 AskUserQuestion으로 물어야 할 질문셋(ERD·LWC·아키텍처·코드 리뷰)과 답변→프롬프트 매핑 정의.
