...
source: forcedotcom/sf-skills (skills/external-diagram-visual-generate/references/architect-aesthetic-guide.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Architect ERD Aesthetic Guide, architect.salesforce.com 스타일 가이드, ERD 미관 가이드]
---
# Official Salesforce Architect ERD Aesthetic Guide — 공식 Architect ERD 미관 가이드
> architect.salesforce.com 시각 스타일(다크 보더 + 라이트 필, 헤더 배너, 레전드, 관계선 표기)을 재현하기 위한 전체 명세.
