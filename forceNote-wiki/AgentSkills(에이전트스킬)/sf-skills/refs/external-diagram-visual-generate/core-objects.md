...
source: forcedotcom/sf-skills (skills/external-diagram-visual-generate/assets/erd/core-objects.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Core Salesforce Objects ERD, 코어 객체 ERD, architect.salesforce.com 스타일 ERD]
---
# ERD Template: Core Salesforce Objects (Architect.salesforce.com Style) — 코어 객체 ERD 템플릿
> architect.salesforce.com 공식 스타일(다크 보더 + 라이트 반투명 필)로 Core CRM 객체 ERD를 생성하는 프롬프트 템플릿.
