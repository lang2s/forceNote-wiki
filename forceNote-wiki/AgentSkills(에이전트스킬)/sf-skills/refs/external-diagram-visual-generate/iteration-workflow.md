---
tags: [agent-skill, sf-skills, reference, diagram, visual, workflow]
source: forcedotcom/sf-skills (skills/external-diagram-visual-generate/references/iteration-workflow.md, 공식 Salesforce)
created: 2026-06-27
aliases: [Iteration Workflow, 반복 워크플로우, Draft to Final 이미지 생성]
---
# Iteration Workflow: Draft → Final — 드래프트→파이널 반복 워크플로우
> 저해상도(1K) 드래프트에서 프롬프트를 다듬은 뒤 4K로 최종 생성하는 비용 효율적 이미지 생성 베스트 프랙티스.
