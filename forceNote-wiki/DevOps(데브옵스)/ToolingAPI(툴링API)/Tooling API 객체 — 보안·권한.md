...
- [[Tooling API 객체 — User·플랫폼이벤트 (이벤트·CDC 채널)]] — User 신원 identity 객체가 본 노트의 UserAccessPolicy·UserEntityAccess·UserFieldAccess와 인접한 형제 Ch4 도메인 노트(User·플랫폼이벤트·CDC 채널·이벤트 릴레이 sObject 7종).
