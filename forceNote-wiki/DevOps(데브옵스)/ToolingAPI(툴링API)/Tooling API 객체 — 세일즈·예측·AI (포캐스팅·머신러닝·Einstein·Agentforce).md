...
- [[Agent Script 메타데이터 배포 (DX·패키징)]] — `GenAiFunction`/`GenAiPlannerBundle` 배포 메타데이터 타입 (BOUNDARY: 여기 GenAiFunctionDefinition·GenAiPlannerDefinition sObject vs 배포 메타데이터 타입)
