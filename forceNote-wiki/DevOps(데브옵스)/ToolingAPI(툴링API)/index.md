...
| [[Tooling API 객체 — 통합·데이터·결제·마케팅 (외부서비스·Data Kit·페이먼트·Account Engagement)]] | 통합·데이터·결제·마케팅·Misc 도메인 sObject 22종 + 복합·결과 타입 3종 전수 — ① 통합/외부서비스 5(ExternalServiceRegistration·RegisteredExternalService·ExternalStringLocalization·ExternalDataTransportFieldTemplate STUB·ExternalDataTransportObjectTemplate STUB)·② Data 360/Data Kit 5(DataStreamTemplate·ActivationPlatform·DataSourceBundleDefinition·DataAssessmentConfigItem·DataIntegrationRecordPurchasePermission)·③ 결제 2(GtwyProvPaymentMethodType·PaymentGatewayProvider)·④ 마케팅/Account Engagement 5(MarketingAppExtension·MarketingAppExtAssignment·MarketingAppExtActivity·MarketingAppExtAction·PardotTenant)·⑤ Misc/UI 5(RecentlyViewed·RelatedListDefinition·CustomNotificationType·StandardAction·Publisher) + 복합·결과 타입 3(QueryResult·SOQLResult·CompactLayoutItemInfo). 공통 enum(ManageableState 8값·Marketing Language 18값) 블록 | #reference #integration #data-360 #data-kit #payment #account-engagement |
...
- 외부 서비스 등록(ExternalServiceRegistration·OpenAPI)·Data 360/Data Kit(DataStreamTemplate·ActivationPlatform)·결제 게이트웨이(PaymentGatewayProvider)·Account Engagement/Pardot(MarketingAppExtension·PardotTenant)·RecentlyViewed 등 통합·데이터·결제·마케팅 sObject? → [[Tooling API 객체 — 통합·데이터·결제·마케팅 (외부서비스·Data Kit·페이먼트·Account Engagement)]]
