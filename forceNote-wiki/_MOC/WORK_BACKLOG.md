...
| OMNISTUDIO-2 | **OmniStudio EPC·Calculation (Industries CPQ)** | OMNISTUDIO-1 실측에서 분리: **Calculation Procedures/Matrices**와 **Enterprise Product Catalog(EPC — Product2 offer·ProductChildItem·CME)**는 OmniStudio Standard 문서세트에 **없음** — Industries CPQ/Communications-Media-Energy Vlocity 관리형 패키지 문서 소속. sf-skill `omnistudio-epc-catalog-generate` 카운터파트. 별도 문서세트 소싱 필요. 니치·저우선. | ~2–4노트 | 🔲 대기 | 2026-07-13 |
