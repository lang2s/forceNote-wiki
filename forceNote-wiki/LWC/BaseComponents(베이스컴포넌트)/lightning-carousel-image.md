...
created: 2026-06-13
aliases: [lightning-carousel-image, Carousel Image]
---

# lightning-carousel-image

> 캐러셀 안의 개별 이미지. · 카테고리: Container
...
```html
<lightning-carousel-image src="/a.jpg" header="제목" description="설명" href="/link"></lightning-carousel-image>
```
...
`lightning-carousel-image` 의 상세 사용법, 변형, 접근성(ARIA), 스타일링 훅 등 전체 설명은 공식 **Develop** 문서를 참고하세요. 이 컴포넌트는 SLDS 블루프린트를 구현하며, 조직 테마에 따라 SLDS 1 또는 SLDS 2 스타일로 렌더링됩니다.
...
- ▶ **Example (실행 예제):** https://developer.salesforce.com/docs/component-library/bundle/lightning-carousel-image/example
- 📖 **Develop (개발 가이드):** https://developer.salesforce.com/docs/component-library/bundle/lightning-carousel-image/documentation
- 📋 **Specification (명세):** https://developer.salesforce.com/docs/component-library/bundle/lightning-carousel-image/specification
- 📚 가이드 페이지: https://developer.salesforce.com/docs/platform/lightning-component-reference/guide/lightning-carousel-image.html
