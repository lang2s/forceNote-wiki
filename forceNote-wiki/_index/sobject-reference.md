...
| 키워드 | 파일 |
|---|---|
| 표준 Object 목록, Standard Object 이동 목록, Salesforce Object 카탈로그, Object API 이름, Ch6 도메인 개요 | `sObject/6 Standard Objects.md` |
| Core CRM Objects, Account, AccountBrand, AccountContactRelation, AccountContactRole, AccountPartner, AccountPlan, AccountTeamMember, Contact, Lead, Opportunity, OpportunityContactRole, OpportunityLineItem, OpportunityHistory, Campaign, CampaignMember, CampaignInfluence, Contract, Order, Pricebook2, Product2, Quote, QuoteLine, Task, Event, ActivityHistory, OpenActivity, ActionCadence, Territory2, UserTerritory2Association, Forecast, ForecastingAdjustment, Partner, ChannelProgram, Scorecard, 거래처, 연락처, 영업 기회, 캠페인, 계약, 가격표, 제품, 견적, 활동, 태스크 | `sObject/Core CRM Objects.md` |
| Service Cloud Objects, Case, CaseComment, CaseArticle, CaseMilestone, CaseTeamMember, CaseContactRole, Entitlement, EntitlementContact, ServiceContract, ContractLineItem, Knowledge__ka, Knowledge__kav, AgentWork, ServiceChannel, ServicePresenceStatus, LiveChatTranscript, LiveChatVisitor, LiveChatButton, MessagingSession, MessagingEndUser, VoiceCall, CallCenter, Survey, SurveyInvitation, SurveyResponse, SurveySubject, Incident, Problem, ChangeRequest, ProblemIncidentRelation, ChangeRequestRelatedItem, Macro, MacroInstruction, QuickText, EmailMessage, SvcCatalogRequest, Swarm, SocialPost, SocialPersona, 케이스, 엔타이틀먼트, 지식, 상담, 라이브채팅, 메시징, 서비스클라우드, 옴니채널, 설문 | `sObject/Service Cloud Objects.md` |
| B2B Commerce Objects, BuyerAccount, BuyerGroup, BuyerGroupMember, WebCart, CartItem, CartCheckoutSession, CartDeliveryGroup, CartItemPriceAdjustment, CartRelatedItem, WebStore, WebStoreCatalog, WebStorePricebook, WebStoreNetwork, OrderSummary, OrderItemSummary, OrderItemSummaryChange, FulfillmentOrder, FulfillmentOrderItem, FulfillmentOrderLineItemSummary, ReturnOrder, ReturnOrderItem, Shipment, ShipmentItem, Location, ProductItem, ProductRequest, ProductRequestLineItem, ProductTransfer, PickTicket, PickTicketItem, PaymentGroup, Payment, Refund, PaymentLineInvoice, PaymentGateway, PaymentGatewayLog, PaymentGatewayProvider, Invoice, InvoiceLine, Promotion, PromotionTarget, PromotionTierInfo, Coupon, CouponCode, CommerceEntitlementPolicy, SalesStore, TaxRate, TaxTreatment, SubscriptionPlan, ProductConsumptionSchedule, 웹카트, 주문, 결제, 배송, 커머스, 구매자, B2B Commerce | `sObject/B2B Commerce Objects.md` |
| Field Service Objects, ServiceAppointment, AssignedResource, ServiceAppointmentFeed, ServiceAppointmentHistory, ServiceResource, ServiceResourceSkill, ServiceResourceFeed, ServiceResourceCapacity, ServiceCrew, ServiceCrewMember, ServiceTerritory, ServiceTerritoryMember, ServiceTerritoryWorkType, WorkOrder, WorkOrderLineItem, ServiceReport, MaintenancePlan, MaintenanceAsset, MaintenanceWorkRule, ProductServiceCampaign, ProductServiceCampaignItem, OperatingHours, TimeSlot, AppointmentSchedulingPolicy, ApptBundleConfig, ApptBundlePolicy, ApptBundlePropagatePolicy, ApptBundleSortPolicy, ApptBundleAggrPolicy, Skill, SkillRequirement, SchedulingRule, SchedulingObjective, WorkType, WorkTypeGroup, WorkTypeGroupMember, ResourceAbsence, ResourcePreference, Asset, AssetRelationship, AssetAction, AssetActionSource, AssetMilestone, AssetStatePeriod, AssetWarranty, WarrantyTerm, Shift, ShiftTemplate, ShiftSegment, ResourceCapacityRequestItem, FieldServiceMobileSettings, FieldServiceSettings, FSL Object, 서비스 약속, 워크오더, 서비스 리소스, 서비스 영역, 유지보수, 에셋, 현장서비스, FSL | `sObject/Field Service Objects.md` |
| Platform Admin Objects, User, UserRole, Group, GroupMember, Organization, OrgWideEmailAddress, Profile, PermissionSet, PermissionSetGroup, PermissionSetAssignment, PermissionSetGroupComponent, ObjectPermissions, FieldPermissions, SetupEntityAccess, UserAppMenuCustomizationShare, AuthProvider, AuthSession, LoginHistory, LoginEvent, LoginGeo, UserLoginEvent, NetworkUserHistoryDownload, RecordType, BusinessProcess, RecordTypeLocalization, ApexClass, ApexTrigger, ApexPage, ApexLog, AsyncApexJob, ApexTestResult, ApexTestRunResult, ApexTestQueueItem, AuraDefinitionBundle, AuraDefinition, LightningComponentBundle, FlexiPage, StaticResource, ExternalDataSource, NamedCredential, RemoteSiteSetting, CustomPermission, FlowRecord, FlowInterview, FlowOrchestration, FlowOrchestrationInstance, FlowOrchestrationWork, ProcessInstance, ProcessInstanceStep, ProcessInstanceHistory, ProcessInstanceWorkitem, Approval, ApprovingProcess, EmailServicesAddress, EmailServicesFunction, SetupAuditTrail, PushTopic, ScratchOrg, Package2, Package2Version, DataKit, AppDefinition, BrandingSet, PathAssistant, DuplicateRecordItem, DuplicateRecordSet, 사용자, 프로파일, 권한셋, 레코드타입, Apex, 플로우, 승인 프로세스, 개발자, 보안, 설정, 플랫폼 관리 | `sObject/Platform Admin Objects.md` |
| Files Objects, ContentDocument, ContentDocumentFeed, ContentDocumentHistory, ContentDocumentLink, ContentVersion, ContentVersionHistory, ContentFolder, ContentFolderItem, ContentFolderLink, ContentFolderMember, ContentWorkspace, ContentWorkspaceMember, ContentDistribution, ContentDistributionView, ContentHubItem, ContentHubRepository, ContentTaxonomy, ContentTaxonomyItem, ContentNotification, ContentUserSubscription, Attachment, Document, DocumentAttachmentMap, Note, NoteAndAttachment, AttachedContentDocument, CombinedAttachment, DigitalSignature, 파일, 첨부파일, 문서, 콘텐츠, ContentDocument | `sObject/Files Objects.md` |
| Analytics Objects, Report, ReportFeed, Dashboard, DashboardFeed, DashboardComponent, AnalyticsDashboard, AnalyticsDashboardFeed, AnalyticsWorkspace, AnalyticsWorkspaceMember, AnalyticsDataflowJob, AnalyticsNotification, EventLogFile, EventLogStream, Individual, ContactPointEmail, ContactPointAddress, ContactPointPhone, ContactPointConsent, DataUsePurpose, DataUseLegalBasis, PartyConsent, AuthorizationFormText, AuthorizationFormConsent, AuthorizationFormDataUse, ProcessException, DataAssessmentMetric, DataAssessmentFieldMetric, DataAssessmentRecord, MLPredictionDefinition, MLModel, MLModelFactor, MLModelFactorComponent, MLRecommendationDefinition, GenAiFunctionDefinition, GenAiPlannerDefinition, GenAiPlugin, GenAiPromptTemplate, ABNExperiment, ABNVersion, SearchActivity, Report 보고서, Dashboard 대시보드, Einstein Analytics, Tableau CRM, Wave Analytics, GDPR, 개인정보, 동의관리, 머신러닝, GenAI, 생성형AI | `sObject/Analytics Objects.md` |
| Experience Cloud Objects, Network, NetworkActivityAudit, NetworkDelegatedAccount, NetworkFeed, NetworkMember, NetworkMemberGroup, NetworkModeration, NetworkPageOverride, NetworkSelfRegistration, NetworkUserHistoryDownload, CollaborationGroup, CollaborationGroupFeed, CollaborationGroupMember, CollaborationGroupMemberRequest, CollaborationGroupRecord, CollaborationDocumentMetric, CollaborationInvitation, CollabDocumentMetric, FeedItem, FeedComment, FeedLike, FeedPoll, FeedPollChoice, FeedPollVote, Idea, IdeaComment, IdeaReputation, IdeaReputationLevel, IdeaTheme, Question, Reply, QuestionSubscription, ChatterConversation, ChatterConversationMember, ChatterMessage, Audience, AudienceCriteria, Recommendation, ReputationLevel, ReputationPoint, ManagedContent, ManagedContentRecord, ManagedContentSpace, NavigationMenuItem, SiteFeed, SiteDetail, BriefcaseDefinition, BriefcaseRule, BriefcaseRuleFilter, BroadcastCommunication, SlackChannelRelatedRecord, Topic, TopicAssignment, TopicFeed, 네트워크, 커뮤니티, 협업그룹, Chatter, 피드, 아이디어, 질문, 게시판, 경험클라우드, Experience Cloud | `sObject/Experience Cloud Objects.md` |
