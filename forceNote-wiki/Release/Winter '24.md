...
- [ ] [[DataWeave Namespace]] — GA 내용, DataWeave 스크립트 메타데이터 방식, Setup UI 열람 방법 추가
...
- [ ] [[Named Credential]] — OAuth 2.0 클라이언트 자격증명, JWT 인증 프로토콜 추가
- [ ] [[Enhanced Domains]] (미작성) — Winter '24 강제 적용 완료 상태 반영
- [ ] [[Salesforce ID 인증]] — 자동 활성화 3단계 및 Summer '24 강제 적용 로드맵 업데이트
- [ ] [[LWC API 버전 관리]] — 컴포넌트 수준 `apiVersion` 지정 패턴 추가
- [ ] [[DevOps Center]] (미작성) — CLI 배포 Beta, Validate-only 배포, 공유 컴포넌트 병합 내용 추가
