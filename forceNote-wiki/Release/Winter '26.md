...
- [ ] [[External Services]] (미작성) — Binary File 지원, 한도 증가(3,000 오브젝트/오퍼레이션, 700 등록) 반영
- [ ] [[Platform Encryption]] (미작성) — Database Encryption GA, Field Audit Trail 선언적 보존 정책 내용 추가
- [ ] [[Salesforce DX 개요]] — MCP Tools (DevOps Center, LWC), `sf package version retrieve`, Quick Create/Clone 내용 추가
- [ ] [[SLDS / LWC 디자인 시스템]] (미작성) — SLDS 2 GA, 다크 모드, 밀도 인식 Styling Hook 내용 추가
